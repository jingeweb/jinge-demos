...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  constructor(args) {
    ...
    _jg0.columns = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)([{
      key: 'name',
      title: 'Name'
    }, {
      key: 'age',
    ...
    _jg0.columns2 = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)([{
      key: '-'
    }, {
      key: 'name',
      title: 'Name'
    ...
    _jg0.data2 = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)([{
      key: 0,
      checked: false,
      name: 'Ge',
      age: 20,
    ...
    _jg0.allChecked = false;
  }
  prependColumn() {
    const _k = (Date.now()).toString(32);
    this.columns.unshift((0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
      key: _k,
      title: 'Col_' + _k
    }));
  ...
  test() {
    this.columns[0] = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
      title: 'TT',
      key: 'age'
    })
  }
  ...
  addRow() {
    this.data2.push((0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
  ...
  modifyRow() {
    ...
    row.age++;
    row.name += `_${row.age}`;
    row.tags = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)((new Array((Math.random() * 4 | 0) + 1)).fill(0).map((n, i) => `Tag${i+1}`));
  }
  toggleAllCheck() {
...
/* harmony export */ });
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge/lib/index.js");
/* harmony import */ var _table_c_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./table.c.html */ "./component/table.c.html");
...
class Table extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  static get template() {
    return _table_c_html__WEBPACK_IMPORTED_MODULE_1__["default"];
  }
  constructor(attrs) {
    if (!(0,jinge__WEBPACK_IMPORTED_MODULE_0__.isArray)(attrs.data) || !(0,jinge__WEBPACK_IMPORTED_MODULE_0__.isArray)(attrs.columns)) {
      throw new Error('bad attribute value.');
    }
    super(attrs);const _jg0 = this[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;const f2_jg0402 = () => {
    _jg0.data = attrs.data; }; f2_jg0402(); attrs[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch("data", f2_jg0402);const f3_jg0402 = () => {
    _jg0.columns = attrs.columns; }; f3_jg0402(); attrs[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch("columns", f3_jg0402);
    _jg0._columnKey = `each.${attrs.columnKey || 'key'}`;
    _jg0._rowKey = `each.${attrs.rowKey || 'key'}`;
  }
}
...
/* harmony export */ });
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge/lib/index.js");
/* harmony import */ var _component_table_c__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./component/table.c */ "./component/table.c.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(component) {
  ...
  ...(() => {
    ...
    const el = _component_table_c__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
    component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
            ...
            (() => {
              const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
                ...
                ...(() => {
                      ...
                      slots: {
                        '-': function(component) {
                          ...
                          (() => {
                            ...
                            const fn_0 = () => {
                              el.checked = !!(vm_0.data2?.length > 0 && vm_0.allChecked);
                            };
                            fn_0();
                        ...
                        'default': function(component) {
                          ...
                          (() => {
                            ...
                            const fn_0 = () => {
                              (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_1.columnIndex}: ${vm_1.columnData?.title}`);
                            };
                            fn_0();
                  ...
                  const fn_0 = () => {
                    attrs.test = vm_1.columnData?.key;
                  };
                  fn_0();
                      ...
                      slots: {
                        ...
                        'tags': function(component) {
                          ...
                          ...(() => {
                                    ...
                                    (() => {
                                      const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElement)(
                                        ...
                                        (() => {
                                          const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
                                          const fn_0 = () => {
                                            (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_2.each}`);
                                          };
                                          fn_0();
                            ...
                            function _calc_0_0_0() {
                              _0_0_0 = vm_1.columnData?.key;
                            }
                            function _calc_0_0() {
                              _0_0 = vm_1.rowData?.[_0_0_0];
                            }
                            function _calc_0() {
                              attrs.loop = _0_0;
                            }
                        ...
                        'default': function(component) {
                          ...
                          (() => {
                            ...
                            function _calc_0() {
                              (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_1.rowIndex}-${vm_1.columnIndex}: ${_0_0}`);
                            }
                            _calc_0_0_0();
                            _calc_0_0();
                            _calc_0();
                            ...
                            vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["columnData","key"], _update_0_0_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
                            _notify_0_0();
                            vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["rowIndex"], _calc_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
                            vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["columnIndex"], _calc_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
                            component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
                            return el;
                          })()
                          ];
    ...
    const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
      ...
      (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
        ...
        (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
          ...
          ...(() => {
                ...
                slots: {
                  'default': function(component) {
                    ...
                    ...(() => {
                        ...
                        (() => {
                          const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
                            ...
                            (() => {
                              const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
                              const fn_0 = () => {
                                (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_1.each?.title || vm_1.each?.key}`);
                              };
                              fn_0();
                      ...
                      fn_1();
                      const el = (new jinge__WEBPACK_IMPORTED_MODULE_0__.ParameterComponent(attrs, ["columnIndex","columnData"]))[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;
            ...
            fn_1();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["_columnKey"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
            const el = jinge__WEBPACK_IMPORTED_MODULE_0__.ForComponent.create(attrs);
            component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].nonRootCompNodes.push(el);
            return (0,jinge__WEBPACK_IMPORTED_MODULE_0__.assertRenderResults)(el.__render());
          })()
      ...
      (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
        ...
        ...(() => {
                            ...
                            slots: {
                              'default': function(component) {
                                ...
                                ...(() => {
                                    ...
                                    (() => {
                                      const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
                                        ...
                                        (() => {
                                          ...
                                          let _0_0_0;
                                          function _calc_0_0_0() {
                                            _0_0_0 = vm_2.each?.dataIndex || vm_2.each?.key;
                                          }
                                          function _calc_0_0() {
                                  ...
                                  fn_3();
                                  const el = (new jinge__WEBPACK_IMPORTED_MODULE_0__.ParameterComponent(attrs, ["rowIndex","rowData","columnIndex","columnData"]))[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;
                                  vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["index"], fn_0, el[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
                                  vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["each"], fn_1, el[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
          ...
          fn_1();
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["_rowKey"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
          const el = jinge__WEBPACK_IMPORTED_MODULE_0__.ForComponent.create(attrs);
          component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].nonRootCompNodes.push(el);
          return (0,jinge__WEBPACK_IMPORTED_MODULE_0__.assertRenderResults)(el.__render());
        })(),
        ...(() => {
                      ...
                      ...(() => {
                        ...
                        const renderFn = __ac && __ac['empty-td'] ? __ac['empty-td'] :   function(component) {
                          ...
                          (() => {
                            ...
                            const fn_0 = () => {
                              (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setAttribute)(el, "colspan", `${vm_0.columns?.length}`);
                            };
                            fn_0();
          ...
          const fn_0 = () => {
            attrs.expect = !vm_0.data || vm_0.data?.length === 0;
          };
          fn_0();
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["data"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
