...
class ToggleClassComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      super(attrs);
      const __vm_a7743eb1190c = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      const fn_2_a7743eb1190c = () => {
        __vm_a7743eb1190c.domClass = attrs.class;
      };
      fn_2_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('class', fn_2_a7743eb1190c);
      const fn_3_a7743eb1190c = () => {
        __vm_a7743eb1190c.transition = !!attrs.transition;
      };
      fn_3_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('transition', fn_3_a7743eb1190c);
      __vm_a7743eb1190c._t = null;
      __vm_a7743eb1190c._i = -1;
      __vm_a7743eb1190c[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('class.**', () => {
...
class DynamicRenderComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      fn_3_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('render', fn_3_a7743eb1190c);
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('*', prop => {
        __vm_a7743eb1190c._currentAttrs[prop[0]] = __vm_a7743eb1190c[_core_component__WEBPACK_IMPORTED_MODULE_1__["__"]].passedAttrs[prop[0]];
      });
    }
    get render() {
        return this._r;
...
class ForComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      if (kn !== 'index' && kn !== 'each') {
        ...
        __vm_a7743eb1190c[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop.*.' + kn.slice(5), propPath => {
      ...
      __vm_a7743eb1190c[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop.*', propPath => {
        if (__vm_a7743eb1190c[_core_component__WEBPACK_IMPORTED_MODULE_1__["__"]].state !== _core_component__WEBPACK_IMPORTED_MODULE_1__["ComponentStates"].RENDERED || propPath.length !== 2 || __vm_a7743eb1190c._waitingUpdate) {
          return;
        }
        const p = _parseIndexPath(propPath[1]);
        if (p === 'length') {
...
class BindHtmlComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      fn_2_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('content', fn_2_a7743eb1190c);
    }
    get content() {
        return this._c;
    }
...
class IfComponent extends _core_component__WEBPACK_IMPORTED_MODULE_2__["Component"] {
    constructor(attrs) {
      ...
      fn_5_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('expect', fn_5_a7743eb1190c);
      const fn_6_a7743eb1190c = () => {
        __vm_a7743eb1190c.transition = attrs.transition;
      };
      fn_6_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('transition', fn_6_a7743eb1190c);
    }
    get expect() {
...
class SwitchComponent extends _core_component__WEBPACK_IMPORTED_MODULE_2__["Component"] {
    constructor(attrs) {
      ...
      fn_5_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('test', fn_5_a7743eb1190c);
      const fn_6_a7743eb1190c = () => {
        __vm_a7743eb1190c.transition = attrs.transition;
      };
      fn_6_a7743eb1190c();
...
class LogComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      fn_1_a7743eb1190c();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('msg', fn_1_a7743eb1190c);
    }
    set msg(v) {
        // eslint-disable-next-line no-console
        console.log(v);
...
/* harmony import */ var _component_table__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./component/table */ "./component/table.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function(component) {
  ...
  ...(() => {
    ...
    const fn_0 = () => {
      attrs.data = vm_0.data;
    };
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["data"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    const fn_1 = () => {
      attrs.columns = vm_0.columns;
    };
    fn_1();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columns"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    const el = _component_table__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
  ...
  (() => {
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      (() => {
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.prependColumn(...args)})
        return el;
      })(),
      (() => {
        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
  ...
  ...(() => {
          ...
          const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
            ...
            ...(() => {
                ...
                [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                  ...
                  (() => {
                    ...
                    const fn_0 = () => {
                      el.checked = !!(function () {
                        let _0;
                        return (_0 = vm_0.data2) === null || _0 === void 0 ? void 0 : _0.length;
                    }() > 0 && vm_0.allChecked);
                    };
                    fn_0();
                    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["data2","length"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["allChecked"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'change', function(...args) {vm_0.toggleAllCheck(...args)})
                    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                    return el;
                  })()
                  ];
                  ...
                  (() => {
                    ...
                    const fn_0 = () => {
                      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, vm_1.columnIndex);
                    };
                    fn_0();
                    vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columnIndex"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                    return el;
                  })(),
                  ...
                  (() => {
                    ...
                    const fn_0 = () => {
                      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, function () {
                        let _0;
                        return (_0 = vm_1.columnData) === null || _0 === void 0 ? void 0 : _0.title;
                    }());
                    };
                    fn_0();
                    vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columnData","title"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                    return el;
                  })()
                  ];
              ...
              const fn_0 = () => {
                attrs.test = function () {
                  let _0;
                  return (_0 = vm_1.columnData) === null || _0 === void 0 ? void 0 : _0.key;
              }();
              };
              fn_0();
              vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columnData","key"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                ...
                [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                  ...
                  (() => {
                    ...
                    const fn_0 = () => {
                      el.checked = !!(function () {
                        let _0;
                        return (_0 = vm_1.rowData) === null || _0 === void 0 ? void 0 : _0.checked;
                    }());
                    };
                    fn_0();
                    vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["rowData","checked"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'change', function(...args) {vm_0.toggleCheck(vm_1.rowData)})
                    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                    return el;
                  })()
                  ];
                  ...
                  (() => {
                    ...
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.removeRow(vm_1.rowIndex)})
                    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                    return el;
                  })()
                  ];
                  ...
                  ...(() => {
                        ...
                        (() => {
                          const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                            ...
                            (() => {
                              const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createTextNode"])();
                              const fn_0 = () => {
                                Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, vm_2.each);
                              };
                              fn_0();
                              vm_2[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                              return el;
                            })()
                          );
                          component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                    ...
                    function _calc_0_0() {
                      _0_0 = function () {
                        let _0;
                        return (_0 = vm_1.rowData) === null || _0 === void 0 ? void 0 : _0[_0_0_0];
                    }();
                    }
                    function _calc_0() {
                      attrs.loop = _0_0;
                    ...
                    vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columnData","key"], _update_0_0_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                    _notify_0_0();
                  ...
                  (() => {
                    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createTextNode"])();
                    const fn_0 = () => {
                      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, vm_1.rowIndex);
                    };
                    fn_0();
                    vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["rowIndex"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                    return el;
                  })(),
                  Object(jinge__WEBPACK_IMPORTED_MODULE_0__["textRenderFn"])(component, "-"),
                  ...
                  (() => {
                    ...
                    function _calc_0() {
                      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, _0_0);
                    }
                    _calc_0_0_0();
                    _calc_0_0();
                    _calc_0();
    ...
    const fn_0 = () => {
      attrs.data = vm_0.data2;
    };
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["data2"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    const fn_1 = () => {
      attrs.columns = vm_0.columns2;
    };
    fn_1();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columns2"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    const el = _component_table__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
    el.__addStylePid(component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid);
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el.__render());
  ...
  (() => {
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      (() => {
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.addRow(...args)})
        return el;
      })(),
      (() => {
        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.modifyRow(...args)})
        return el;
      })()
    );
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    ...
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          ...(() => {
            const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
              [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                ...
                ...(() => {
                  ...
                  const renderFn = __ac && __ac['th'] ? __ac['th'] :   function(component) {
                    return [
                    (() => {
                      const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                        "th",
                        ...
                        (() => {
                          ...
                          const fn_0 = () => {
                            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, function () {
                              let _0;
                              return (_0 = vm_1.each) === null || _0 === void 0 ? void 0 : _0.title;
                          }() || function () {
                              let _0;
                              return (_0 = vm_1.each) === null || _0 === void 0 ? void 0 : _0.key;
                          }());
                          };
                          fn_0();
                          vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each","title"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                          vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each","key"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                          return el;
                        })()
                      );
                      component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                  ...
                  const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
                    columnIndex: null, columnData: null, 
                    [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                  ...
                  const fn_0 = () => {
                    attrs.columnIndex = vm_1.index;
                  };
                  fn_0();
                  const fn_1 = () => {
                    attrs.columnData = vm_1.each;
                  };
                  fn_1();
                  const el = new jinge__WEBPACK_IMPORTED_MODULE_0__["ParameterComponent"](attrs, ["columnIndex","columnData"]);
                  el.__addStylePid(component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid);
                  vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["index"], fn_0, el[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                  vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each"], fn_1, el[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                  component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                  return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el.__render());
                })()
                ];
            ...
            const fn_0 = () => {
              attrs.loop = vm_0.columns;
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columns"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
            const fn_1 = () => {
              attrs.key = vm_0._columnKey;
            };
            fn_1();
            const el = jinge__WEBPACK_IMPORTED_MODULE_0__["ForComponent"].create(attrs);
            component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].nonRootCompNodes.push(el);
      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        ...(() => {
                  ...
                  ...(() => {
                    const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
                      [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                        ...
                        ...(() => {
                          const __ac = vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].slots;
                          const renderFn = __ac && __ac['td'] ? __ac['td'] :   function(component) {
                            return [
                            (() => {
                              const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                                "td",
                                ...
                                (() => {
                                  ...
                                  function _calc_0_0_0() {
                                    _0_0_0 = function () {
                                      let _0;
                                      return (_0 = vm_2.each) === null || _0 === void 0 ? void 0 : _0.dataIndex;
                                  }() || function () {
                                      let _0;
                                      return (_0 = vm_2.each) === null || _0 === void 0 ? void 0 : _0.key;
                                  }();
                                  }
                                  function _calc_0_0() {
                                    _0_0 = function () {
                                      let _0;
                                      return (_0 = vm_1.each) === null || _0 === void 0 ? void 0 : _0[_0_0_0];
                                  }();
                                  }
                                  function _calc_0() {
                                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, _0_0);
                                  ...
                                  vm_2[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each","dataIndex"], _update_0_0_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                                  vm_2[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each","key"], _update_0_0_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                                  _notify_0_0();
                                  return el;
                                })()
                              );
                          ...
                          const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
                            rowIndex: null, rowData: null, columnIndex: null, columnData: null, 
                            [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                              debugName: "attrs_of_<parameter>",      
                              context: component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].context,
                              slots: {
                          ...
                          const fn_0 = () => {
                            attrs.rowIndex = vm_1.index;
                          };
                          fn_0();
                          const fn_1 = () => {
                            attrs.rowData = vm_1.each;
                          };
                          fn_1();
                          const fn_2 = () => {
                            attrs.columnIndex = vm_2.index;
                          };
                          fn_2();
                          const fn_3 = () => {
                            attrs.columnData = vm_2.each;
                          };
                          fn_3();
                          const el = new jinge__WEBPACK_IMPORTED_MODULE_0__["ParameterComponent"](attrs, ["rowIndex","rowData","columnIndex","columnData"]);
                          el.__addStylePid(component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid);
                          vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["index"], fn_0, el[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                          vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each"], fn_1, el[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                          vm_2[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["index"], fn_2, el[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                          vm_2[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each"], fn_3, el[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                          component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                          return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el.__render());
                        })()
                        ];
          ...
          const fn_0 = () => {
            attrs.loop = vm_0.data;
          };
          fn_0();
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["data"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
          const fn_1 = () => {
            attrs.key = vm_0._rowKey;
          };
          fn_1();
          const el = jinge__WEBPACK_IMPORTED_MODULE_0__["ForComponent"].create(attrs);
          component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].nonRootCompNodes.push(el);
        ...
        ...(() => {
            ...
            [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
              ...
              (() => {
                const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                  ...
                  ...(() => {
                    const __ac = vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].slots;
                    const renderFn = __ac && __ac['empty-td'] ? __ac['empty-td'] :   function(component) {
                      return [
                      (() => {
                        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                          "td",
                        ...
                        const fn_0 = () => {
                          Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setAttribute"])(el, "colspan", function () {
                            let _0;
                            return (_0 = vm_0.columns) === null || _0 === void 0 ? void 0 : _0.length;
                        }());
                        };
                        fn_0();
                        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["columns","length"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                        component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                        return el;
                      })()
                      ];
          ...
          const fn_0 = () => {
            attrs.expect = !vm_0.data || function () {
              let _0;
              return (_0 = vm_0.data) === null || _0 === void 0 ? void 0 : _0.length;
          }() === 0;
          };
          fn_0();
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["data"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["data","length"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
...
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge-framework/lib/index.js");
/* harmony import */ var _table_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./table.html */ "./component/table.html");




class Table extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static get template() {
    return _table_html__WEBPACK_IMPORTED_MODULE_1__["default"];
  }
  constructor(attrs) {
    if (!Object(jinge__WEBPACK_IMPORTED_MODULE_0__["isArray"])(attrs.data) || !Object(jinge__WEBPACK_IMPORTED_MODULE_0__["isArray"])(attrs.columns)) {
      throw new Error('bad attribute value.');
    }
    super(attrs);
    const __vm_a7743eb1190c = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    const fn_2_a7743eb1190c = () => {
      __vm_a7743eb1190c.data = attrs.data;
    };
    fn_2_a7743eb1190c();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('data', fn_2_a7743eb1190c);
    const fn_3_a7743eb1190c = () => {
      __vm_a7743eb1190c.columns = attrs.columns;
    };
    fn_3_a7743eb1190c();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('columns', fn_3_a7743eb1190c);
    __vm_a7743eb1190c._columnKey = `each.${ attrs.columnKey || 'key' }`;
    __vm_a7743eb1190c._rowKey = `each.${ attrs.rowKey || 'key' }`;
  }
}
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    super(args);
    const __vm_a7743eb1190c = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    __vm_a7743eb1190c.data = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([
      {
        name: 'Ge',
        age: 20
      },
    ...
    __vm_a7743eb1190c.columns = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([
      {
        key: 'name',
        title: 'Name'
      },
    ...
    __vm_a7743eb1190c.columns2 = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([
      { key: '-' },
      {
        key: 'name',
        title: 'Name'
    ...
    __vm_a7743eb1190c.data2 = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([
      {
        key: 0,
        checked: false,
        name: 'Ge',
    ...
    __vm_a7743eb1190c.allChecked = false;
  }
  prependColumn() {
    const _k = (Date.now()).toString(32);
    this.columns.unshift(Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
      key: _k,
      title: 'Col_' + _k
    }));
  ...
  test() {
    this.columns[0] = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
      title: 'TT',
      key: 'age'
    })
  }
  ...
  addRow() {
    this.data2.push(Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
  ...
  modifyRow() {
    ...
    row.age++;
    row.name += `_${row.age}`;
    row.tags = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])((new Array((Math.random() * 4 | 0) + 1)).fill(0).map((n, i) => `Tag${i+1}`));
  }
  toggleAllCheck() {
