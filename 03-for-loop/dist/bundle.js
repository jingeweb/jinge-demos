    ...
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        ...(() => {
          const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
            [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
              ...
              ...(() => {
                const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
                  [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                    ...
                    slots: {
                      'default': function(component) {
                    return [
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["textRenderFn"])(component, "First: ")
                    ];
                  }
                  }
                  },
                ...
                const fn_0 = () => {
                  attrs.expect = vm_1.isFirst;
                };
                fn_0();
                vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["isFirst"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
              ...
              (() => {
                ...
                const fn_0 = () => {
                  Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, vm_1.index);
                };
                fn_0();
              ...
              ...(() => {
                ...
                const fn_0 = () => {
                  attrs.expect = !vm_1.isLast;
                };
                fn_0();
                vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["isLast"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                const el = jinge__WEBPACK_IMPORTED_MODULE_0__["IfComponent"].create(attrs);
                el.__addStylePid(component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid);
                component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el.__render());
          ...
          const fn_0 = () => {
            attrs.loop = vm_0.numbers;
          };
          fn_0();
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["numbers"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        (() => {
          ...
          Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.push(...args)})
          return el;
        })()
      )
    );
      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          ...(() => {
            ...
            const fn_0 = () => {
              attrs.loop = vm_0.persons;
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["persons"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
            const el = jinge__WEBPACK_IMPORTED_MODULE_0__["ForComponent"].create(attrs);
            component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].nonRootCompNodes.push(el);
            return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el.__render());
          })()
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    ...
    __vm_cd786ab284ed.INC = 10;
    __vm_cd786ab284ed.numbers = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([
      0,
      1,
      2
    ]);
    __vm_cd786ab284ed.persons = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([
      {
        id: '001',
        name: 'XiaoGe'
      },
    ...
    setInterval(() => {
      __vm_cd786ab284ed.numbers.push(AUTO_INC++);
      __vm_cd786ab284ed.persons.push(Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
  ...
  test($evt) {
    ...
    // return;
    // console.log($evt);
    this.numbers = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([6, 0, 7, 3, 2]);
