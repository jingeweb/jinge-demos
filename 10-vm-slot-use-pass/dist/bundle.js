...
class A extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  constructor(args) {
    ...
    _jg0.store = _jg0.__getContext('STORE');
  }
}
...
/* harmony export */ });
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge/lib/index.js");
/* harmony import */ var _b_c_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./b.c.html */ "./b.c.html");




class B extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  static template = _b_c_html__WEBPACK_IMPORTED_MODULE_1__["default"];

  constructor(args) {
    super(args);const _jg0 = this[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;
    const store = _jg0.__getContext('STORE');
    _jg0.k = store.count;
    _jg0._h = () => {
      _jg0.k = store.count;
    };
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(store, 'count', _jg0._h);
  }
  __beforeDestroy() {
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.unwatch)(this.__getContext('STORE'), 'count', this._h);
  }
}
  ...
  (() => {
    const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
      ...
      ...(() => {
        ...
        const renderFn = __ac && __ac['oo'] ? __ac['oo'] :   function(component) {
          return [
          (() => {
            const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
            const fn_0 = () => {
              (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `oo-${vm_0.store?.count + 1}`);
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["store","count"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
        ...
        const fn_0 = () => {
          attrs.aa = vm_0.store?.count + 1;
        };
        fn_0();
        const el = (new jinge__WEBPACK_IMPORTED_MODULE_0__.ParameterComponent(attrs, ["aa"]))[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["store","count"], fn_0, el[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
      ...
      ...(() => {
        ...
        const renderFn = __ac && __ac['default'] ? __ac['default'] :   function(component) {
          ...
          (() => {
            const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
            const fn_0 = () => {
              (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `default-${vm_0.store?.count}`);
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["store","count"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
            component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
...
/* harmony import */ var _b_c__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./b.c */ "./b.c.js");
  ...
  (() => {
    const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
      ...
      (() => {
        const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
        const fn_0 = () => {
          (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_0.aa}, ${vm_0.bb}`);
        };
        fn_0();
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["aa"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["bb"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
        return el;
      })()
    );
    component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
        ...
        slots: {
          'default': function(component) {
            ...
            (() => {
              const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
              const fn_0 = () => {
                (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_1.aa}, ${vm_0.bb}`);
              };
              fn_0();
            ...
            (() => {
              const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
                ...
                (() => {
                  const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
                  const fn_0 = () => {
                    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_1.aa}`);
                  };
                  fn_0();
                  vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["aa"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
                  return el;
              ...
              const fn_0 = () => {
                (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setAttribute)(el, "data-x", vm_1.aa);
              };
              fn_0();
              vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["aa"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
              component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
            ...
            (() => {
              const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
                ...
                (() => {
                  const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
                  const fn_0 = () => {
                    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_0.bb}`);
                  };
                  fn_0();
                  vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["bb"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
                  return el;
            ...
            slots: {
              'oo': function(component) {
                ...
                (() => {
                  const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
                  const fn_0 = () => {
                    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `oo-${vm_1.bb}`);
                  };
                  fn_0();
                  vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["bb"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
                  component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
                  return el;
                })()
                ];
      ...
      ...(() => {
        ...
        const renderFn = __ac && __ac['default'] ? __ac['default'] :   function(component) {
          ...
          (() => {
            const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createTextNode)();
            const fn_0 = () => {
              (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `default-${vm_0.k}`);
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["k"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
            component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
            return el;
          })()
          ];
        ...
        fn_0();
        const el = (new jinge__WEBPACK_IMPORTED_MODULE_0__.ParameterComponent(attrs, ["bb"]))[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["k"], fn_0, el[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
        component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].nonRootCompNodes.push(el);
        return (0,jinge__WEBPACK_IMPORTED_MODULE_0__.assertRenderResults)(el.__render());
      })(),
      ...(() => {
        const __ac = vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.__].slots;
        const renderFn = __ac && __ac['oo'] ? __ac['oo'] : null;
        const attrs = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.attrs)({
          bb: null, 
          [jinge__WEBPACK_IMPORTED_MODULE_0__.__]: {
            debugName: "attrs_of_<parameter>",
