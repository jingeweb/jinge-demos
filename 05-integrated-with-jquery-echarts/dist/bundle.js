...
/* harmony import */ var _app_c_html__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./app.c.html */ "./app.c.html");
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  static get template() {
    return _app_c_html__WEBPACK_IMPORTED_MODULE_3__["default"];
  }
  constructor(args) {
    super(args);const _jg0 = this[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;
    _jg0._btnHandler = _jg0.onButtonClick.bind(_jg0);
    _jg0._chart = null;
  }
  __afterRender() {
  ...
  onButtonClick($evt) {
    console.log($evt);
    if (!this._chart) {
      this._chart = echarts__WEBPACK_IMPORTED_MODULE_2___default().init(this.__getRef('chart'));
    }
