...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  constructor(args) {
    ...
    _jg0.n = 10;
    _jg0.boy1 = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
      name: 'ge',
      girlfriend: {
        name: 'jing'
      },
    ...
    _jg0.boy2 = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
      name: 'yy',
      children: [{
        name: 'pp'
      }]
    ...
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0, '**', (propPath) => {
      console.log('root: anything changed.', propPath);
    });

    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0, 'boy1.**', (propPath) => {
      console.log('root: boy1 deep notify.', propPath);
    });

    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0, 'boy2.children.*.name', (propPath) => {
      console.log('root: boy2.children.*.name notify', propPath);
    });

    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0, 'boy2.*.name', (propPath) => {
      console.log('root: boy2.*.name notify.', propPath);
    });

    // array item watch
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0.boy1, 'children.1.name', (propPath) => {
      console.log('boy1: children[1].name notify.', propPath);
    });
    // deep watch
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0.boy1, 'children.**', (propPath) => {
    ...
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0.boy2, 'xxx.ooo', _jg0._h);
  }
  test1() {
    /*
  ...
  test2() {
     ...
     * 无论路径对应的实际值是否发生变化。
     */
    this.boy2 = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
      name: 'ge'
    });
  }

  test3() {
    this.boy1.children.push((0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
      name: 'ppp'
    }));
  }
  ...
  clear() {
    ...
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.unwatch)(this);
    // clear all listeners on path 'children.**'
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.unwatch)(this.boy1, 'children.**');
    // remove specify listener
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.unwatch)(this.boy2, 'xxx.ooo', this._h);
  }
}
