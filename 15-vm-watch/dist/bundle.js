...
/* harmony default export */ __webpack_exports__["default"] = (function(component) {
  ...
  (() => {
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      "p",
      component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid,
      "Please see code and console output."
    );
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return el;
  })(),
  (() => {
    ...
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.test1(...args)})
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return el;
  })(),
  (() => {
    ...
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.test2(...args)})
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return el;
  })(),
  (() => {
    ...
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.test3(...args)})
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return el;
  })(),
  (() => {
    ...
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.clear(...args)})
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return el;
  })()
  ];
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    ...
    __vm_a7743eb1190c.n = 10;
    __vm_a7743eb1190c.boy1 = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
      name: 'ge',
      girlfriend: { name: 'jing' },
      children: [{ name: 'yuang' }]
    });
    __vm_a7743eb1190c.boy2 = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
      name: 'yy',
      children: [{ name: 'pp' }]
    });
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c, '**', propPath => {
      console.log('root: anything changed.', propPath);
    });
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c, 'boy1.**', propPath => {
      console.log('root: boy1 deep notify.', propPath);
    });
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c, 'boy2.children.*.name', propPath => {
      console.log('root: boy2.children.*.name notify', propPath);
    });
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c, 'boy2.*.name', propPath => {
      console.log('root: boy2.*.name notify.', propPath);
    });
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c.boy1, 'children.1.name', propPath => {
      console.log('boy1: children[1].name notify.', propPath);
    });
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c.boy1, 'children.**', propPath => {
      console.log('boy1: deep children notify', propPath);
    });
    __vm_a7743eb1190c._h = propPath => {
      console.log('boy2: xxx.ooo notify.', propPath);
    };
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c.boy2, 'xxx.ooo', __vm_a7743eb1190c._h);
  }
  test1() {
    /*
  ...
  test2() {
     ...
     * 无论路径对应的实际值是否发生变化。
     */
    this.boy2 = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
      name: 'ge'
    });
  }

  test3() {
    this.boy1.children.push(Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
      name: 'ppp'
    }));
  }
  ...
  clear() {
    ...
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["unwatch"])(this);
    // clear all listeners on path 'children.**'
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["unwatch"])(this.boy1, 'children.**');
    // remove specify listener
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["unwatch"])(this.boy2, 'xxx.ooo', this._h);
  }
}
