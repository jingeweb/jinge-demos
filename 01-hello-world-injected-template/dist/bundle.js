...
class Girl extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    ...
    const fn_1_cd786ab284ed = () => {
      __vm_cd786ab284ed.name = args.name;
    };
    fn_1_cd786ab284ed();
    args[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('name', fn_1_cd786ab284ed);
  }
  __afterRender() {
...
class Boy extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
            ...
            (() => {
              const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                ...
                ...(() => {
                  ...
                  fn_0();
                  vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["girl"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                  vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["clickTimes"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                  const el = _girl__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
  ...
  constructor(attrs) {
    ...
    const __vm_cd786ab284ed = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    const fn_1_cd786ab284ed = () => {
      __vm_cd786ab284ed.clickTimes = attrs.clickTimes;
    };
    fn_1_cd786ab284ed();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('clickTimes', fn_1_cd786ab284ed);
    const fn_2_cd786ab284ed = () => {
      __vm_cd786ab284ed.name = attrs.name;
    };
    fn_2_cd786ab284ed();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('name', fn_2_cd786ab284ed);
    const fn_3_cd786ab284ed = () => {
      __vm_cd786ab284ed.girl = attrs.girl;
    };
    fn_3_cd786ab284ed();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('girl', fn_3_cd786ab284ed);
  }
}
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static get template() {
    return function(component) {
      ...
      ...(() => {
        ...
        fn_1();
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["clickTimes"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
        const el = Boy.create(attrs);
        el.__addStylePid(component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid);
        component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
        return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el.__render());
      })(),
  ...
  constructor(args) {
    super(args);
    const __vm_cd786ab284ed = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    __vm_cd786ab284ed.clickTimes = 0;
  }
  log(...args) {
    console.log(...args);
  }
