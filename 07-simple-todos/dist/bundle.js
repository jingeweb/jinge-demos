      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
            ...
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
              ...
              (() => {
                ...
                const fn_0 = () => {
                  el.disabled = !!(function () {
                    let _0;
                    return (_0 = vm_0.todos) === null || _0 === void 0 ? void 0 : _0.length;
                }() === 0);
                };
                fn_0();
                vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["todos","length"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                const fn_1 = () => {
                  el.checked = !!(vm_0.allDone);
                };
                fn_1();
                vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["allDone"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.toggleAllDone(...args)})
                return el;
              })()
            ),
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          ...(() => {
                  ...
                  const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                    ...
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
                      ...
                      (() => {
                        ...
                        fn_0();
                        vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each","done"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.toggleDone(vm_1.each)})
                        return el;
                      })()
                    ),
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
                    ...
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
                      ...
                      (() => {
                        ...
                        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.modify(vm_1.each)})
                        return el;
                      })(),
                      (() => {
                        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
                        ...
                        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.remove(vm_1.each)})
                        return el;
                      })()
                    )
                  );
            ...
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["todos"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
  ...
  (() => {
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      (() => {
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.add(...args)})
        return el;
      })(),
      (() => {
        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
...
function createTodo(title, done = false) {
  return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
    title,
    done
  });
}
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    ...
    __vm_92fb158b76b3.todos = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])(loadTodos() || [createTodo('test')]);
    __vm_92fb158b76b3.allDone = __vm_92fb158b76b3.todos.length > 0 && !__vm_92fb158b76b3.todos.find(t => !t.done);
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_92fb158b76b3, 'todos.**', () => {
      __vm_92fb158b76b3.__updateIfNeed();
    });
  }
