...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  constructor(args) {
    ...
    _jg0.todos = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)(loadTodos() || [createTodo('test')]);
    _jg0.allDone = _jg0.todos.length > 0 && !_jg0.todos.find(t => !t.done);
     ...
     */
    (0,jinge__WEBPACK_IMPORTED_MODULE_0__.watch)(_jg0, 'todos.**', () => {
      /**
      ...
      (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
          ...
          (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
            ...
            (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
              ...
              (() => {
                ...
                const fn_0 = () => {
                  el.disabled = !!(vm_0.todos?.length === 0);
                };
                fn_0();
        ...
        (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
          ...
          ...(() => {
            ...
            const fn_0 = () => {
              attrs.expect = vm_0.todos?.length === 0;
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["todos","length"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
