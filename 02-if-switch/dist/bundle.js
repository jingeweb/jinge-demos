...
class ToggleClassComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs) {
    ...
    const vm_2a5f103141 = super(attrs);
    const fn_2a5f103141_2 = () => {
      vm_2a5f103141.class = attrs.class;
    };
    fn_2a5f103141_2();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('class', fn_2a5f103141_2);
    const fn_2a5f103141_3 = () => {
      vm_2a5f103141.trans = !!attrs.transition;
    };
    fn_2a5f103141_3();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('transition', fn_2a5f103141_3);
    vm_2a5f103141._t = null;
    vm_2a5f103141._i = null;
    Object(_vm__WEBPACK_IMPORTED_MODULE_4__["vmWatch"])(this, 'class.**', () => {
      vm_2a5f103141[_core__WEBPACK_IMPORTED_MODULE_2__["UPDATE_IF_NEED"]]();
    });
    return vm_2a5f103141;
  }
...
class ForEachComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs, item, index, isLast) {
    const vm_2a5f103141 = super(attrs);
    vm_2a5f103141.each = item;
    vm_2a5f103141.index = index;
    vm_2a5f103141.isFirst = index === 0;
    vm_2a5f103141.isLast = isLast;
    return vm_2a5f103141;
  }
...
class ForComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs) {
    ...
    const vm_2a5f103141 = super(attrs);
    const fn_2a5f103141_2 = () => {
      vm_2a5f103141.loop = attrs.loop;
    };
    fn_2a5f103141_2();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('loop', fn_2a5f103141_2);
    vm_2a5f103141[ID] = INC++;
    const kn = attrs.key || KEY_INDEX;
    vm_2a5f103141[FOR_KEY_NAME] = kn;
    vm_2a5f103141[FOR_LENGTH] = 0;
    vm_2a5f103141[FOR_KEYS] = null;
    vm_2a5f103141[FOR_WAIT_UPDATE] = false;
    if (kn !== KEY_INDEX && kn !== KEY_EACH) {
      vm_2a5f103141[FOR_KEY_NAME] = new Function(KEY_EACH, `return ${ kn }`);
      const propCount = kn.split('.').length + 1;
      Object(_vm__WEBPACK_IMPORTED_MODULE_4__["vmWatch"])(this, 'loop.*.' + kn.slice(5), propPath => {
        if (propPath.length !== propCount || vm_2a5f103141[FOR_WAIT_UPDATE]) {
          return;
        }
        const items = vm_2a5f103141.loop;
        ...
        vm_2a5f103141[FOR_KEYS][p] = vm_2a5f103141[FOR_KEY_NAME](items[p]);
      });
    }
    Object(_vm__WEBPACK_IMPORTED_MODULE_4__["vmWatch"])(this, 'loop.*', propPath => {
      if (vm_2a5f103141[_core__WEBPACK_IMPORTED_MODULE_2__["STATE"]] !== _core__WEBPACK_IMPORTED_MODULE_2__["STATE_RENDERED"] || propPath.length !== 2 || vm_2a5f103141[FOR_WAIT_UPDATE]) {
        return;
      }
      const p = _parseIndexPath(propPath[1]);
      if (p === _util__WEBPACK_IMPORTED_MODULE_3__["STR_LENGTH"]) {
        vm_2a5f103141[FOR_WAIT_UPDATE] = true;
        vm_2a5f103141[_core__WEBPACK_IMPORTED_MODULE_2__["UPDATE_IF_NEED"]]();
      } else if (Object(_util__WEBPACK_IMPORTED_MODULE_3__["isNumber"])(p)) {
        vm_2a5f103141[FOR_UPDATE_ITEM](p);
      }
    });
    return vm_2a5f103141;
  }
...
class BindHtmlComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs) {
    ...
    const vm_2a5f103141 = super(attrs);
    const fn_2a5f103141_3 = () => {
      vm_2a5f103141.c = attrs.content;
    };
    fn_2a5f103141_3();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('content', fn_2a5f103141_3);
    return vm_2a5f103141;
  }
...
class I18nComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs, renderKey, renderVms) {
    const vm_2a5f103141 = super(attrs);
    vm_2a5f103141[RENDER_KEY] = renderKey;
    vm_2a5f103141[RENDER_VMS] = renderVms;
    vm_2a5f103141[_core__WEBPACK_IMPORTED_MODULE_2__["I18N_WATCH"]](vm_2a5f103141[ON_LOCALE_CHANGE]);
    return vm_2a5f103141;
  }
...
class IfComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs) {
    const vm_2a5f103141 = super(attrs);
    vm_2a5f103141[C_VAL] = _util__WEBPACK_IMPORTED_MODULE_3__["STR_DEFAULT"];
    vm_2a5f103141[OE_H] = null;
    vm_2a5f103141[T_MAP] = null;
    vm_2a5f103141[P_VAL] = null;
    const fn_2a5f103141_5 = () => {
      vm_2a5f103141.expect = attrs.expect;
    };
    fn_2a5f103141_5();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('expect', fn_2a5f103141_5);
    const fn_2a5f103141_6 = () => {
      vm_2a5f103141.ts = attrs.transition;
    };
    fn_2a5f103141_6();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('transition', fn_2a5f103141_6);
    return vm_2a5f103141;
  }
...
class SwitchComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs) {
    ...
    vm_2a5f103141[T_MAP] = null;
    vm_2a5f103141[P_VAL] = null;
    const fn_2a5f103141_4 = () => {
      vm_2a5f103141.test = attrs.test;
    };
    fn_2a5f103141_4();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('test', fn_2a5f103141_4);
    const fn_2a5f103141_5 = () => {
      vm_2a5f103141.ts = attrs.transition;
    };
    fn_2a5f103141_5();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('transition', fn_2a5f103141_5);
    return vm_2a5f103141;
  }
...
class LogComponent extends _core__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  constructor(attrs) {
    const vm_2a5f103141 = super(attrs);
    const fn_2a5f103141_1 = () => {
      vm_2a5f103141.msg = attrs.msg;
    };
    fn_2a5f103141_1();
    attrs[_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][_vm_core__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('msg', fn_2a5f103141_1);
    return vm_2a5f103141;
  }
          ...
          const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["wrapAttrs"])({
            ...
            [jinge__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
              [jinge__WEBPACK_IMPORTED_MODULE_0__["STR_DEFAULT"]]: function(component) {
                return [
                Object(jinge__WEBPACK_IMPORTED_MODULE_0__["textRenderFn"])(component, "It's greater than 5.")
                ];
              }
            }
          });
        ...
        ...(() => {
          const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["wrapAttrs"])({
            ...
            [jinge__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
              [jinge__WEBPACK_IMPORTED_MODULE_0__["STR_DEFAULT"]]: function(component) {
                return [
                Object(jinge__WEBPACK_IMPORTED_MODULE_0__["textRenderFn"])(component, "It's less or equal than 5.")
                ];
              }
            }
          });
            ...
            [jinge__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
              [jinge__WEBPACK_IMPORTED_MODULE_0__["STR_DEFAULT"]]: function(component) {
                ...
                (() => {
                  ...
                  const fn_0 = () => {
                    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setAttribute"])(el, "style", 'color: ' + (vm_0.n >= 8 ? 'red' : 'blue'));
                  };
                  fn_0();
                  vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["n"], fn_0, component);
                  component[jinge__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]].push(el);
    ...
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        (() => {
          ...
          const fn_0 = () => {
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setAttribute"])(el, "class", vm_0.n <= 5 ? 'hide' : '');
          };
          fn_0();
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["n"], fn_0, component);
          return el;
          ...
          const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["wrapAttrs"])({
            ...
            [jinge__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
              ['0']: function(component) {
                return [
                Object(jinge__WEBPACK_IMPORTED_MODULE_0__["textRenderFn"])(component, "零")
                ];
              },
              ['3']: function(component) {
                return [
                Object(jinge__WEBPACK_IMPORTED_MODULE_0__["textRenderFn"])(component, "三")
                ];
              },
                ...
                ...(() => {
                  const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["wrapAttrs"])({
                    ...
                    [jinge__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
                      [jinge__WEBPACK_IMPORTED_MODULE_0__["STR_DEFAULT"]]: function(component) {
                        return [
                        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["textRenderFn"])(component, " > 5")
                        ];
                      }
                    }
                  });
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_2__["Component"] {
  ...
  constructor(args) {
    const vm_2a5f103141 = super(args);
    vm_2a5f103141.n = 0;
    setInterval(() => {
      vm_2a5f103141.n = Math.random() * 10 | 0;
      console.log(vm_2a5f103141.n);
    }, 1000);
    return vm_2a5f103141;
  }
  log(...args) {
