...
class ToggleClassComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      super(attrs);
      const __vm_cd786ab284ed = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      const fn_2_cd786ab284ed = () => {
        __vm_cd786ab284ed.domClass = attrs.class;
      };
      fn_2_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('class', fn_2_cd786ab284ed);
      const fn_3_cd786ab284ed = () => {
        __vm_cd786ab284ed.transition = !!attrs.transition;
      };
      fn_3_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('transition', fn_3_cd786ab284ed);
      __vm_cd786ab284ed._t = null;
      __vm_cd786ab284ed._i = -1;
      __vm_cd786ab284ed[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('class.**', () => {
        __vm_cd786ab284ed.__updateIfNeed();
      });
    }
    __render() {
...
class DynamicRenderComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      super(attrs);
      const __vm_cd786ab284ed = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      __vm_cd786ab284ed._currentAttrs = null;
      const fn_3_cd786ab284ed = () => {
        __vm_cd786ab284ed.render = attrs.render;
      };
      fn_3_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('render', fn_3_cd786ab284ed);
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('*', prop => {
        __vm_cd786ab284ed._currentAttrs[prop[0]] = __vm_cd786ab284ed[_core_component__WEBPACK_IMPORTED_MODULE_1__["__"]].passedAttrs[prop[0]];
      });
    }
    get render() {
        return this._r;
...
class ForEachComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs, item, index, isLast) {
      ...
      if (Object(_vm_common__WEBPACK_IMPORTED_MODULE_0__["isViewModel"])(item)) {
        __vm_cd786ab284ed.each = item;
      } else {
        __vm_cd786ab284ed._e = item;
      }
      __vm_cd786ab284ed.index = index;
      __vm_cd786ab284ed.isFirst = index === 0;
      __vm_cd786ab284ed.isLast = isLast;
    }
    get each() {
        return this._e;
    }
...
class ForComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      if (Object(_vm_common__WEBPACK_IMPORTED_MODULE_0__["isViewModel"])(attrs.loop)) {
        __vm_cd786ab284ed.loop = attrs.loop;
      } else {
        __vm_cd786ab284ed._l = attrs.loop;
      }
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop', () => {
        __vm_cd786ab284ed.loop = attrs.loop;
      });
      const kn = attrs.key || 'index';
      __vm_cd786ab284ed._keyName = kn;
      __vm_cd786ab284ed._length = 0;
      __vm_cd786ab284ed._keys = null;
      __vm_cd786ab284ed._waitingUpdate = false;
      if (kn !== 'index' && kn !== 'each') {
        __vm_cd786ab284ed._keyName = new Function('each', `return ${ kn }`);
        const propCount = kn.split('.').length + 1;
        __vm_cd786ab284ed[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop.*.' + kn.slice(5), propPath => {
          if (propPath.length !== propCount || __vm_cd786ab284ed._waitingUpdate) {
            return;
          }
          const items = __vm_cd786ab284ed.loop;
          ...
          __vm_cd786ab284ed._keys[p] = __vm_cd786ab284ed._keyName(items[p]);
        });
      }
      __vm_cd786ab284ed[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop.*', propPath => {
        if (__vm_cd786ab284ed[_core_component__WEBPACK_IMPORTED_MODULE_1__["__"]].state !== _core_component__WEBPACK_IMPORTED_MODULE_1__["ComponentStates"].RENDERED || propPath.length !== 2 || __vm_cd786ab284ed._waitingUpdate) {
          return;
        }
        const p = _parseIndexPath(propPath[1]);
        if (p === 'length') {
          __vm_cd786ab284ed._waitingUpdate = true;
          __vm_cd786ab284ed.__updateIfNeed();
        } else if (Object(_util__WEBPACK_IMPORTED_MODULE_3__["isNumber"])(p)) {
          __vm_cd786ab284ed._updateItem(p);
        }
      });
    }
    get loop() {
    ...
    __update() {
        ...
        const $parent = (ol === 0 ? firstEl : firstEl.__firstDOM);
        if (keyName === 'index') {
            let $f = null;
            if (ol === 0)
                roots.length = 0;
...
class BindHtmlComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      const __vm_cd786ab284ed = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      const fn_2_cd786ab284ed = () => {
        __vm_cd786ab284ed.content = attrs.content;
      };
      fn_2_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('content', fn_2_cd786ab284ed);
    }
    get content() {
        return this._c;
    }
...
class I18nComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs, renderKey, renderVms) {
      super(attrs);
      const __vm_cd786ab284ed = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      __vm_cd786ab284ed._key = renderKey;
      __vm_cd786ab284ed._vms = renderVms;
      __vm_cd786ab284ed.__i18nWatch(__vm_cd786ab284ed._onchange);
    }
    __render() {
...
function createEl(renderFn, context, parentStyleIds) {
    const el = _core_component__WEBPACK_IMPORTED_MODULE_2__["Component"].create(Object(_vm__WEBPACK_IMPORTED_MODULE_1__["attrs"])({
...
class IfComponent extends _core_component__WEBPACK_IMPORTED_MODULE_2__["Component"] {
    constructor(attrs) {
      ...
      fn_5_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('expect', fn_5_cd786ab284ed);
      const fn_6_cd786ab284ed = () => {
        __vm_cd786ab284ed.transition = attrs.transition;
      };
      fn_6_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('transition', fn_6_cd786ab284ed);
    }
    get expect() {
...
class SwitchComponent extends _core_component__WEBPACK_IMPORTED_MODULE_2__["Component"] {
    constructor(attrs) {
      ...
      fn_5_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('test', fn_5_cd786ab284ed);
      const fn_6_cd786ab284ed = () => {
        __vm_cd786ab284ed.transition = attrs.transition;
      };
      fn_6_cd786ab284ed();
...
class LogComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      super(attrs);
      const __vm_cd786ab284ed = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      const fn_1_cd786ab284ed = () => {
        __vm_cd786ab284ed.msg = attrs.msg;
      };
      fn_1_cd786ab284ed();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('msg', fn_1_cd786ab284ed);
    }
    set msg(v) {
        // eslint-disable-next-line no-console
        console.log(v);
...
/* harmony import */ var _vm__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../vm */ "../../jinge-framework/lib/vm/index.js");

function bootstrap(ComponentClazz, dom, attrs) {
    const bootComponent = new ComponentClazz(Object(_vm__WEBPACK_IMPORTED_MODULE_0__["attrs"])(attrs || {}));
...
/***/ "../../jinge-framework/lib/lib.js":
/*!***********************************************************************!*\
  !*** /Users/geyuhang/workspace/jinge-mvvm/jinge-framework/lib/lib.js ***!
  \***********************************************************************/
/*! exports provided: typeOf, isObject, isString, isNumber, isUndefined, isArray, instanceOf, isBoolean, isFunction, isDOMNode, isPromise, arrayRemove, arrayPushIfNotExist, arrayEqual, uid, setImmediate, clearImmediate, setText, createTextNode, createFragment, appendChildren, replaceChildren, removeAttribute, setAttribute, createElement, createElementWithoutAttrs, createSVGElement, createSVGElementWithoutAttrs, createElementWithChild, insertAfter, addEvent, removeEvent, registerEvent, vm, attrs, $$, ToggleClassComponent, ForEachComponent, ForComponent, HideComponent, BindHtmlComponent, IfComponent, SwitchComponent, ParameterComponent, LogComponent, I18nComponent, DynamicRenderComponent, Component, bootstrap, __ */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./util */ "../../jinge-framework/lib/util/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "typeOf", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["typeOf"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isObject", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["isObject"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isNumber", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["isNumber"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isUndefined", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["isUndefined"]; });
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "instanceOf", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["instanceOf"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isBoolean", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["isBoolean"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isFunction", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["isFunction"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isDOMNode", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["isDOMNode"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "isPromise", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["isPromise"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "arrayRemove", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["arrayRemove"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "arrayPushIfNotExist", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["arrayPushIfNotExist"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "arrayEqual", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["arrayEqual"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "uid", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["uid"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setImmediate", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["setImmediate"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "clearImmediate", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["clearImmediate"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setText", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["setText"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createTextNode", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["createTextNode"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createFragment", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["createFragment"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "appendChildren", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["appendChildren"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "replaceChildren", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["replaceChildren"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "removeAttribute", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["removeAttribute"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "setAttribute", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["setAttribute"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createElement", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["createElement"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createElementWithoutAttrs", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createSVGElement", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["createSVGElement"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createSVGElementWithoutAttrs", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["createSVGElementWithoutAttrs"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "createElementWithChild", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["createElementWithChild"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "insertAfter", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["insertAfter"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "addEvent", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["addEvent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "removeEvent", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["removeEvent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "registerEvent", function() { return _util__WEBPACK_IMPORTED_MODULE_0__["registerEvent"]; });

/* harmony import */ var _vm__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./vm */ "../../jinge-framework/lib/vm/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "vm", function() { return _vm__WEBPACK_IMPORTED_MODULE_1__["vm"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "attrs", function() { return _vm__WEBPACK_IMPORTED_MODULE_1__["attrs"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "$$", function() { return _vm__WEBPACK_IMPORTED_MODULE_1__["$$"]; });

/* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./components */ "../../jinge-framework/lib/components/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ToggleClassComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["ToggleClassComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ForEachComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["ForEachComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ForComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["ForComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "HideComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["HideComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "BindHtmlComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["BindHtmlComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "IfComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["IfComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "SwitchComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["SwitchComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ParameterComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["ParameterComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LogComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["LogComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "I18nComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["I18nComponent"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DynamicRenderComponent", function() { return _components__WEBPACK_IMPORTED_MODULE_2__["DynamicRenderComponent"]; });

/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./core */ "../../jinge-framework/lib/core/index.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Component", function() { return _core__WEBPACK_IMPORTED_MODULE_3__["Component"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "bootstrap", function() { return _core__WEBPACK_IMPORTED_MODULE_3__["bootstrap"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "__", function() { return _core__WEBPACK_IMPORTED_MODULE_3__["__"]; });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge-framework/lib/lib.js");
