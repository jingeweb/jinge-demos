...
/******/ 	return __webpack_require__(__webpack_require__.s = "./jinge/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony import */ var _core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../core */ "../../jinge-framework/core/index.js");
/* harmony import */ var _util__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../util */ "../../jinge-framework/util/index.js");
/* harmony import */ var _vm__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../vm */ "../../jinge-framework/vm/index.js");




class ToggleClassComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs) {
    if (!attrs || !Object(_util__WEBPACK_IMPORTED_MODULE_1__["isObject"])(attrs.class)) {
    ...
    Object(_vm__WEBPACK_IMPORTED_MODULE_2__["vmWatch"])(this, 'class.**', () => {
      this[_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE_IF_NEED"]]();
    });
  }

  [_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]() {
    const rr = super[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]();
    this[_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE"]](true);
    return rr;
  }

  [_core__WEBPACK_IMPORTED_MODULE_0__["BEFORE_DESTROY"]]() {
    this._t && this._t.clear();
  }

  [_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE"]](init) {
    const el = this.trans ? this[_core__WEBPACK_IMPORTED_MODULE_0__["GET_TRANSITION_DOM"]]() : this;
    ...
    Object.keys(cs).forEach(k => {
      const v = cs[k];
      if (!this.trans) {
        Object(_core__WEBPACK_IMPORTED_MODULE_0__["operateRootHtmlDOM"])(
          v ? _util__WEBPACK_IMPORTED_MODULE_1__["addClass"] : _util__WEBPACK_IMPORTED_MODULE_1__["removeClass"],
          el, k
        );
        return;
      }
      ...
      if (init) {
        this._t.set(k, [
          v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVED"], // state
          null // saved onEnd callback
        ]);
        v ? Object(_util__WEBPACK_IMPORTED_MODULE_1__["addClass"])(el, k) : Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, k);
        return;
      }
      ...
      const s = t[0];
      if ((v && s <= _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"]) || (!v && s >= _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVING"])) {
        return;
      }

      if (s === (v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVING"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERING"])) {
        // debugger;
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, k + (v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER"]));
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, k + (v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE_ACTIVE"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER_ACTIVE"]));
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION_END"], t[1]);
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_ANIMATION_END"], t[1]);
        t[1] = null;
        this[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_LEAVE_CANCELLED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_ENTER_CANCELLED"], k, el);
      }
      const classOfStart = k + (v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE"]);
      const classOfActive = k + (v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER_ACTIVE"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE_ACTIVE"]);
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["addClass"])(el, classOfStart);
      // force render by calling getComputedStyle
      Object(_core__WEBPACK_IMPORTED_MODULE_0__["getDurationType"])(el);
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["addClass"])(el, classOfActive);
      const tsEndName = Object(_core__WEBPACK_IMPORTED_MODULE_0__["getDurationType"])(el);
      if (!tsEndName) {
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, classOfStart);
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, classOfActive);
        t[0] = v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVED"];
        v ? Object(_util__WEBPACK_IMPORTED_MODULE_1__["addClass"])(el, k) : Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, k);
        return;
      }
      const onEnd = () => {
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION_END"], onEnd);
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_ANIMATION_END"], onEnd);
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, classOfStart);
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, classOfActive);
        t[1] = null;
        t[0] = v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVED"];
        v ? Object(_util__WEBPACK_IMPORTED_MODULE_1__["addClass"])(el, k) : Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, k);
        this[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_AFTER_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_AFTER_LEAVE"], k, el);
      };
      t[0] = v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERING"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVING"];
      t[1] = onEnd;
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["addEvent"])(el, tsEndName, onEnd);
      this[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_BEFORE_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_BEFORE_LEAVE"], k, el);
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["setImmediate"])(() => {
        this[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], v ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_LEAVE"], k, el);
      });
    });
  }
}
...
const FOR_LENGTH = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('length');
const FOR_KEYS = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('keys');
const FOR_KEY_NAME = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('key');
const FOR_WAIT_UPDATE = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('waiting_update');
const FOR_UPDATE_ITEM = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('update_item');

const KEY_INDEX = 'index';
const KEY_EACH = 'each';
const EMP_ARR = [];

class ForEachComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  [_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]() {
    const renderFn = this[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]][_util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"]];
    if (!renderFn) Object(_util__WEBPACK_IMPORTED_MODULE_1__["assertFail"])();
    return renderFn(this);
  }
}

function createEl(item, i, isLast, itemRenderFn, context, cstyPid) {
  const el = new ForEachComponent(Object(_vm__WEBPACK_IMPORTED_MODULE_2__["wrapAttrs"])({
    [_vm__WEBPACK_IMPORTED_MODULE_2__["VM_DEBUG_NAME"]]: 'attrs_of_<for-each>',
    [_vm__WEBPACK_IMPORTED_MODULE_2__["VM_ATTRS"]]: null,
    [_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]]: context,
    [_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
      [_util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"]]: itemRenderFn
    }
  }), item, i, isLast);
  cstyPid && Object(_core__WEBPACK_IMPORTED_MODULE_0__["addParentStyleId"])(el, cstyPid);
  return el;
}
...
function appendRenderEach(item, i, isLast, itemRenderFn, roots, context, cstyPid) {
  ...
  roots.push(el);
  return el[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]();
}

function _assertVm(item, i) {
  if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["isObject"])(item) && !Object(_vm__WEBPACK_IMPORTED_MODULE_2__["isInnerObj"])(item) && !(_vm__WEBPACK_IMPORTED_MODULE_2__["VM_ATTRS"] in item)) {
...
function loopAppend($parent, el) {
  el[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]].forEach(node => {
    if (Object(_core__WEBPACK_IMPORTED_MODULE_0__["isComponent"])(node)) {
      loopAppend($parent, node);
    } else {
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["appendChild"])($parent, node);
    }
  });
}
...
function _parseIndexPath(p) {
  return (Object(_util__WEBPACK_IMPORTED_MODULE_1__["isString"])(p) && p !== _util__WEBPACK_IMPORTED_MODULE_1__["STR_LENGTH"] && /^\d+$/.test(p)) ? Number(p) : p;
}

let INC = 0;
const ID = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('id');

class ForComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs) {
    ...
    if (kn !== KEY_INDEX && kn !== KEY_EACH) {
      ...
      Object(_vm__WEBPACK_IMPORTED_MODULE_2__["vmWatch"])(this, 'loop.*.' + kn.slice(5), propPath => {
        ...
        if (!Object(_util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(items) || items.length === 0) return;
        const p = _parseIndexPath(propPath[1]);
        if (!Object(_util__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(p) || p >= items.length) {
          return;
        }
    ...
    Object(_vm__WEBPACK_IMPORTED_MODULE_2__["vmWatch"])(this, 'loop.*', propPath => {
      if (this[_core__WEBPACK_IMPORTED_MODULE_0__["STATE"]] !== _core__WEBPACK_IMPORTED_MODULE_0__["STATE_RENDERED"] || propPath.length !== 2 || this[FOR_WAIT_UPDATE]) {
      ...
      // console.log(propPath);
      const p = _parseIndexPath(propPath[1]);
      if (p === _util__WEBPACK_IMPORTED_MODULE_1__["STR_LENGTH"]) {
        this[FOR_WAIT_UPDATE] = true;
        this[_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE_IF_NEED"]]();
      } else if (Object(_util__WEBPACK_IMPORTED_MODULE_1__["isNumber"])(p)) {
  ...
  [_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]() {
    const roots = this[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]];
    const itemRenderFn = this[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]] ? this[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]][_util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"]] : null;
    if (!itemRenderFn) {
      roots.push(Object(_util__WEBPACK_IMPORTED_MODULE_1__["createComment"])(_util__WEBPACK_IMPORTED_MODULE_1__["STR_EMPTY"]));
      return roots;
    }
    const items = this.loop;
    const keyName = this[FOR_KEY_NAME];
    if (keyName !== KEY_INDEX) this[FOR_KEYS] = [];
    if (!Object(_util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(items) || items.length === 0) {
      roots.push(Object(_util__WEBPACK_IMPORTED_MODULE_1__["createComment"])(_util__WEBPACK_IMPORTED_MODULE_1__["STR_EMPTY"]));
      return roots;
    }
    ...
    return renderItems(
      ...
      this[FOR_KEYS],
      keyName,
      this[_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]],
      this[_core__WEBPACK_IMPORTED_MODULE_0__["CSTYLE_PID"]]
    );
  }
  ...
  [FOR_UPDATE_ITEM](index) {
    const items = this.loop;
    const roots = this[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]];
    if (!Object(_util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(items) || index >= roots.length) return;
    ...
    if (keyName !== KEY_INDEX) {
      ...
      if (newKey !== oldKey) {
        const $fd = oldEl[_core__WEBPACK_IMPORTED_MODULE_0__["GET_FIRST_DOM"]]();
        const newEl = createEl(
          item, index, oldEl.isLast,
          itemRenderFn, this[_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]], this[_core__WEBPACK_IMPORTED_MODULE_0__["CSTYLE_PID"]]
        );
        const rr = newEl[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]();
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertBefore"])(Object(_util__WEBPACK_IMPORTED_MODULE_1__["getParent"])($fd), rr, $fd);
        oldEl[_core__WEBPACK_IMPORTED_MODULE_0__["DESTROY"]]();
        roots[index] = newEl;
        keys[index] = newKey;
        newEl[_core__WEBPACK_IMPORTED_MODULE_0__["HANDLE_AFTER_RENDER"]]();
  ...
  [_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE"]]() {
    this[FOR_WAIT_UPDATE] = false;
    // console.log('for update');
    const itemRenderFn = this[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]] ? this[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]][_util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"]] : null;
    if (!itemRenderFn) return;

    const newItems = Object(_util__WEBPACK_IMPORTED_MODULE_1__["isArray"])(this.loop) ? this.loop : EMP_ARR;
    const roots = this[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]];
    ...
    if (nl === 0 && ol > 0) {
      const fd = roots[0][_core__WEBPACK_IMPORTED_MODULE_0__["GET_FIRST_DOM"]]();
      const $cmt = Object(_util__WEBPACK_IMPORTED_MODULE_1__["createComment"])(_util__WEBPACK_IMPORTED_MODULE_1__["STR_EMPTY"]);
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertBefore"])(Object(_util__WEBPACK_IMPORTED_MODULE_1__["getParent"])(fd), $cmt, fd);
      for (let i = 0; i < ol; i++) {
        roots[i][_core__WEBPACK_IMPORTED_MODULE_0__["DESTROY"]]();
      }
      roots.length = 1;
      roots[0] = $cmt;
      if (keyName !== KEY_INDEX) {
    ...
    this[FOR_LENGTH] = nl;
    const ctx = this[_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]];
    const cstyPid = this[_core__WEBPACK_IMPORTED_MODULE_0__["CSTYLE_PID"]];
    const firstEl = roots[0]; // if ol === 0, firstEl is comment, else is component
    const $parent = Object(_util__WEBPACK_IMPORTED_MODULE_1__["getParent"])(ol === 0 ? firstEl : firstEl[_core__WEBPACK_IMPORTED_MODULE_0__["GET_FIRST_DOM"]]());
    ...
    if (keyName === KEY_INDEX) {
      ...
      for (let i = 0; i < nl; i++) {
        if (i < ol) {
          ...
          if (!$f) $f = Object(_util__WEBPACK_IMPORTED_MODULE_1__["createFragment"])();
          Object(_util__WEBPACK_IMPORTED_MODULE_1__["appendChild"])($f, ...appendRenderEach(newItems[i], i, i === nl - 1, itemRenderFn, roots, ctx, cstyPid));
        }
      }
      if ($f) {
        const $le = ol === 0 ? firstEl : roots[ol - 1][_core__WEBPACK_IMPORTED_MODULE_0__["GET_LAST_DOM"]]();
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertAfter"])($parent, $f, $le);
        for (let i = ol; i < nl; i++) {
          roots[i][_core__WEBPACK_IMPORTED_MODULE_0__["HANDLE_AFTER_RENDER"]]();
        }
      }
      if (ol === 0) {
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeChild"])($parent, firstEl);
      }
      if (nl >= ol) return;
      for (let i = nl; i < ol; i++) {
        roots[i][_core__WEBPACK_IMPORTED_MODULE_0__["DESTROY"]]();
    ...
    if (ol === 0) {
      ...
      const rs = renderItems(
        ...
        oldKeys, keyName, this[_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]], this[_core__WEBPACK_IMPORTED_MODULE_0__["CSTYLE_PID"]]
      );
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertAfter"])($parent, Object(_util__WEBPACK_IMPORTED_MODULE_1__["createFragment"])(rs), firstEl);
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeChild"])($parent, firstEl);
      roots.forEach(el => el[_core__WEBPACK_IMPORTED_MODULE_0__["HANDLE_AFTER_RENDER"]]());
      return;
    }
    ...
    while (oi < ol || ni < nl) {
      while (oi < ol) {
        if (oldTags[oi] !== 0) {
          ...
          if (oi === ol - 1) {
            $lastS = roots[oi][_core__WEBPACK_IMPORTED_MODULE_0__["GET_LAST_DOM"]]().nextSibling;
          }
          break;
        } else {
          if (oi === ol - 1) {
          ...
          roots[oi][_core__WEBPACK_IMPORTED_MODULE_0__["DESTROY"]]();
          oi++;
        }
      }
      if (oi >= ol) {
        ...
        for (; ni < nl; ni++) {
          ...
          if (!$f) $f = Object(_util__WEBPACK_IMPORTED_MODULE_1__["createFragment"])();
          Object(_util__WEBPACK_IMPORTED_MODULE_1__["appendChild"])($f, ...el[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]());
          newRoots.push(el);
        }
        if ($f) {
          if ($lastS) {
            Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertBefore"])($parent, $f, $lastS);
          } else {
            Object(_util__WEBPACK_IMPORTED_MODULE_1__["appendChild"])($parent, $f);
          }
          for (let i = cei; i < newRoots.length; i++) {
            newRoots[i][_core__WEBPACK_IMPORTED_MODULE_0__["HANDLE_AFTER_RENDER"]]();
          }
        }
        break;
      }
      ...
      while (ni < nl) {
        ...
        if (!reuseEl) {
          ...
          Object(_util__WEBPACK_IMPORTED_MODULE_1__["appendChild"])($f, ...reuseEl[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]());
          if (!$nes) $nes = [];
          $nes.push(reuseEl);
        } else {
      ...
      if (ni >= nl) {
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["assertFail"])('unimpossible?!');
      }
      const el = roots[oi];
      $f && Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertBefore"])($parent, $f, el[_core__WEBPACK_IMPORTED_MODULE_0__["GET_FIRST_DOM"]]());
      $nes && $nes.forEach(el => el[_core__WEBPACK_IMPORTED_MODULE_0__["HANDLE_AFTER_RENDER"]]());
    ...
    this[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]] = newRoots;
...
function renderHtml(content) {
  const $d = Object(_util__WEBPACK_IMPORTED_MODULE_1__["createElementWithoutAttrs"])('div');
  $d.innerHTML = content || '';
  let cn = $d.childNodes;
  if (cn.length === 0) {
    cn = [Object(_util__WEBPACK_IMPORTED_MODULE_1__["createComment"])(_util__WEBPACK_IMPORTED_MODULE_1__["STR_EMPTY"])];
  } else {
...
class BindHtmlComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs) {
    if (attrs[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]) throw new Error('<bind-html/> don\'t accept any child.');
  ...
  [_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]() {
    return (this[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]] = renderHtml(this._c));
  }

  [_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE"]]() {
    const roots = this[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]];
    const oldFirstEl = roots[0];
    const $p = Object(_util__WEBPACK_IMPORTED_MODULE_1__["getParent"])(oldFirstEl);
    const newEls = renderHtml(this._c);
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertBefore"])($p, newEls, oldFirstEl);
    roots.forEach(oldEl => Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeChild"])($p, oldEl));
    this[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]] = newEls;
  }
}
...
class I18nComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs, renderKey, renderVms) {
    super(attrs);
    this[RENDER_KEY] = renderKey;
    this[RENDER_VMS] = renderVms;
    this[_core__WEBPACK_IMPORTED_MODULE_0__["I18N_WATCH"]](this[ON_LOCALE_CHANGE]);
  }

  [_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]() {
    const renderFn = _core__WEBPACK_IMPORTED_MODULE_0__["i18n"][_core__WEBPACK_IMPORTED_MODULE_0__["I18N_GET_RENDER"]](this[RENDER_KEY]);
  ...
  [_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE"]]() {
    Object(_vm__WEBPACK_IMPORTED_MODULE_2__["vmRelatedClear"])(this[_vm__WEBPACK_IMPORTED_MODULE_2__["VM_RELATED_LISTENERS"]]);

    let $el = this[_core__WEBPACK_IMPORTED_MODULE_0__["GET_LAST_DOM"]]();
    const $parentEl = Object(_util__WEBPACK_IMPORTED_MODULE_1__["getParent"])($el);
    $el = $el.nextSibling;

    /*
     * 当前实现下，HANDLE_BEFORE_DESTROY 正好可以销毁子组件/子元素。
     */
    this[_core__WEBPACK_IMPORTED_MODULE_0__["HANDLE_BEFORE_DESTROY"]](true);
    /*
     * 将新的元素替换到原来的旧的元素的位置。
     */
    const els = this[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]();
    if ($el) {
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertBefore"])($parentEl, els, $el);
    } else {
      Object(_util__WEBPACK_IMPORTED_MODULE_1__["appendChild"])($parentEl, els);
    }
  }
...
const T_MAP = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('transition_map');
const P_VAL = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('previous_value');
const OE_H = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('on_end_handler');

const C_BV = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('current_branch_value');
const C_VAL = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('current_value');
const ON_TS_END = Object(_util__WEBPACK_IMPORTED_MODULE_1__["Symbol"])('on_ts_end');

function createEl(renderFn, context, parentStyleIds) {
  const el = new _core__WEBPACK_IMPORTED_MODULE_0__["Component"](Object(_vm__WEBPACK_IMPORTED_MODULE_2__["wrapAttrs"])({
    [_vm__WEBPACK_IMPORTED_MODULE_2__["VM_DEBUG_NAME"]]: 'attrs_of_<if>',
    [_vm__WEBPACK_IMPORTED_MODULE_2__["VM_ATTRS"]]: null,
    [_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]]: context,
    [_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
      [_util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"]]: renderFn
    }
  }));
  parentStyleIds && Object(_core__WEBPACK_IMPORTED_MODULE_0__["addParentStyleId"])(el, parentStyleIds);
  return el;
}

function renderSwitch(component) {
  const value = component[C_VAL];
  const acs = component[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]];
  if (component.ts && acs) {
    const t = new Map();
    for (const k in acs) {
      t.set(k, [
        k === value ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVED"],
        null // element
      ]);
    }
    component[T_MAP] = t;
  ...
  const roots = component[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]];
  if (!renderFn) {
    roots.push(Object(_util__WEBPACK_IMPORTED_MODULE_1__["createComment"])(_util__WEBPACK_IMPORTED_MODULE_1__["STR_EMPTY"]));
    return roots;
  }
  const el = createEl(renderFn, component[_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]], component[_core__WEBPACK_IMPORTED_MODULE_0__["CSTYLE_PID"]]);
  roots.push(el);
  return el[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]();
}

function updateSwitch(component) {
  if (!Object(_core__WEBPACK_IMPORTED_MODULE_0__["isComponent"])(component[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]][0]) && (
    !component[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]] || !component[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]][component[C_VAL]]
  )) {
    return;
  }
...
function doUpdate(component) {
  const roots = component[_core__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]];
  const el = roots[0];
  const isC = Object(_core__WEBPACK_IMPORTED_MODULE_0__["isComponent"])(el);
  const fd = isC ? el[_core__WEBPACK_IMPORTED_MODULE_0__["GET_FIRST_DOM"]]() : el;
  const pa = Object(_util__WEBPACK_IMPORTED_MODULE_1__["getParent"])(isC ? fd : el);
  const renderFn = component[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]] ? component[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]][component[C_VAL]] : null;
  const ne = renderFn ? createEl(renderFn, component[_core__WEBPACK_IMPORTED_MODULE_0__["CONTEXT"]], component[_core__WEBPACK_IMPORTED_MODULE_0__["CSTYLE_PID"]]) : null;
  roots[0] = ne || Object(_util__WEBPACK_IMPORTED_MODULE_1__["createComment"])(_util__WEBPACK_IMPORTED_MODULE_1__["STR_EMPTY"]);
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["insertBefore"])(
    pa,
    ne ? ne[_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]() : roots[0],
    fd
  );
  if (isC) {
    el[_core__WEBPACK_IMPORTED_MODULE_0__["DESTROY"]]();
  } else {
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeChild"])(pa, fd);
  }
  ne && renderFn && ne[_core__WEBPACK_IMPORTED_MODULE_0__["HANDLE_AFTER_RENDER"]]();
  component[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]]('branch-switched', component[C_BV]);
}
...
function cancelTs(t, tn, e, component) {
  ...
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, tn + (e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE"]));
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, tn + (e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER_ACTIVE"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE_ACTIVE"]));
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION_END"], onEnd);
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_ANIMATION_END"], onEnd);
  component[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_ENTER_CANCELLED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_LEAVE_CANCELLED"], el);
}
...
function startTs(t, tn, e, component) {
  ...
  const classOfStart = tn + (e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE"]);
  const classOfActive = tn + (e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER_ACTIVE"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE_ACTIVE"]);
  ...
  t[0] = e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERING"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVING"];
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["addEvent"])(el, tsEndName, onEnd);
  component[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_BEFORE_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_BEFORE_LEAVE"], el);
  Object(_util__WEBPACK_IMPORTED_MODULE_1__["setImmediate"])(() => {
    component[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_LEAVE"], el);
  });
}
function updateSwitchWithTransition(component) {
  ...
  if (!pt) {
    pt = [
      pv === IF_STR_ELSE ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"],
      null // element
    ];
    component[T_MAP].set(pv, pt);
  }
  // debugger;
  if (pt[0] === _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERING"]) {
    if (value === pv) return;
    cancelTs(pt, tn, true, component);
    startTs(pt, tn, false, component);
  } else if (pt[0] === _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVING"]) {
    if (value !== pv) return;
    cancelTs(pt, tn, false, component);
    startTs(pt, tn, true, component);
  } else if (pt[0] === _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"]) {
    pt[1] = component[_core__WEBPACK_IMPORTED_MODULE_0__["GET_TRANSITION_DOM"]]();
    startTs(pt, tn, false, component);
  } else if (pt[0] === _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVED"]) {
    pt[1] = component[_core__WEBPACK_IMPORTED_MODULE_0__["GET_TRANSITION_DOM"]]();
    startTs(pt, tn, true, component);
  }
}
...
function updateSwitchOnTransitionEnd(component) {
  ...
  const e = pt[0] === _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERING"];
  const el = pt[1];

  if (el.nodeType === Node.ELEMENT_NODE) {
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION_END"], component[OE_H]);
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(el, _core__WEBPACK_IMPORTED_MODULE_0__["TS_ANIMATION_END"], component[OE_H]);
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, tn + (e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE"]));
    Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeClass"])(el, tn + (e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_ENTER_ACTIVE"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_C_LEAVE_ACTIVE"]));
    component[_core__WEBPACK_IMPORTED_MODULE_0__["NOTIFY"]](_core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION"], e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_AFTER_ENTER"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_AFTER_LEAVE"]);
  }

  pt[0] = e ? _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"] : _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_LEAVED"];
  ...
  const fd = component[_core__WEBPACK_IMPORTED_MODULE_0__["GET_TRANSITION_DOM"]]();
  if (fd.nodeType !== Node.ELEMENT_NODE) {
    ct[0] = _core__WEBPACK_IMPORTED_MODULE_0__["TS_STATE_ENTERED"];
    return;
  }
...
function destroySwitch(component) {
  ...
  if (tMap) {
    tMap.forEach((ts, v) => {
      if (ts[1]) {
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(ts[1], _core__WEBPACK_IMPORTED_MODULE_0__["TS_TRANSITION_END"], component[OE_H]);
        Object(_util__WEBPACK_IMPORTED_MODULE_1__["removeEvent"])(ts[1], _core__WEBPACK_IMPORTED_MODULE_0__["TS_ANIMATION_END"], component[OE_H]);
      }
      ts.length = 0;
    });
    tMap.clear();
...
class IfComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs) {
    super(attrs);

    this[C_VAL] = _util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"];
    this[OE_H] = null;
    this[T_MAP] = null;
    this[P_VAL] = null;
  ...
  get expect() {
    return this[C_VAL] === _util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"];
  }

  set expect(v) {
    v = v ? _util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"] : IF_STR_ELSE;
...
class SwitchComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs) {
    super(attrs);
  ...
  set test(v) {
    const acs = this[_core__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]];
    if (!acs || !(v in acs)) {
      v = _util__WEBPACK_IMPORTED_MODULE_1__["STR_DEFAULT"];
    }
    if (this[C_VAL] === v) return;
    this[C_VAL] = v;
    this[_core__WEBPACK_IMPORTED_MODULE_0__["UPDATE_IF_NEED"]]();
 ...
 */
class LogComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs) {
    super(attrs);
    this.msg = attrs.msg;
  }
  ...
  [_core__WEBPACK_IMPORTED_MODULE_0__["RENDER"]]() {
    return [Object(_util__WEBPACK_IMPORTED_MODULE_1__["createComment"])('log placeholder')];
  }
}
...
class ParameterComponent extends _core__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  constructor(attrs, params) {
    super(attrs);
    params.forEach(p => {
      this[p] = attrs[p];
      attrs[_vm__WEBPACK_IMPORTED_MODULE_1__["VM_ATTRS"]][_vm__WEBPACK_IMPORTED_MODULE_1__["VM_ON"]](p, () => {
        this[p] = attrs[p];
      });
    });
  }
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge-framework/index.js");
/* harmony import */ var _app_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./app.html */ "./jinge/app.html");
