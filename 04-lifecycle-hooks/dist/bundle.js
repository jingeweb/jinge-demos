...
/* harmony import */ var _boy__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./boy */ "./boy.js");
  ...
  (() => {
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      ...(() => {
        const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
          [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
            ...
            ...(() => {
              const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
                [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
                  debugName: "attrs_of_<Boy>",
                  context: component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].context,
                  listeners: {
                    someApiCalled: { fn: function(...args) { vm_0.onBoyApiCalled(...args) }, opts: null }
                },
                },
                name: null
              });
              ...
              fn_0();
              vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["name"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
              vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["inc"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
              const el = _boy__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
              el.__addStylePid(component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid);
              vm_0.__setRef('boy', el, component)
              component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
        ...
        fn_0();
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["showBoy"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
      ...
      (() => {
        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          (() => {
            ...
            const fn_0 = () => {
              Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, vm_0.showBoy ? 'Hide' : 'Show');
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["showBoy"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
            return el;
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.showBoy = !vm_0.showBoy;vm_0.inc++;vm_0.log(args[0], vm_0.inc)})
        return el;
      })(),
      ...(() => {
        const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
          [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
            ...
            (() => {
              ...
              Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.callApi(...args)})
              component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
              return el;
            })()
            ];
...
/* harmony default export */ __webpack_exports__["default"] = (function(component) {
  ...
  (() => {
    ...
    vm_0.__setRef('someId', el, component)
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return el;
  })()
  ];
...
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge-framework/lib/index.js");
/* harmony import */ var _boy_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./boy.html */ "./boy.html");




class Boy extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static get template() {
    return _boy_html__WEBPACK_IMPORTED_MODULE_1__["default"];
  }
  constructor(attrs) {
    super(attrs);
    const __vm_cd786ab284ed = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    const fn_1_cd786ab284ed = () => {
      __vm_cd786ab284ed.name = attrs.name;
    };
    fn_1_cd786ab284ed();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('name', fn_1_cd786ab284ed);
  }
  someApi() {
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    super(args);
    const __vm_cd786ab284ed = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    __vm_cd786ab284ed.showBoy = true;
    __vm_cd786ab284ed.inc = 0;
    __vm_cd786ab284ed.name = 'Jinge';
  }
  __afterRender() {
    /**
