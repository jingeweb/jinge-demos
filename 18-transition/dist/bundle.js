...
class ToggleClassComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      super(attrs);
      const __vm_e2cc19144ac8 = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      const fn_2_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.domClass = attrs.class;
      };
      fn_2_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('class', fn_2_e2cc19144ac8);
      const fn_3_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.transition = !!attrs.transition;
      };
      fn_3_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('transition', fn_3_e2cc19144ac8);
      __vm_e2cc19144ac8._t = null;
      __vm_e2cc19144ac8._i = -1;
      __vm_e2cc19144ac8[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('domClass.**', () => {
        __vm_e2cc19144ac8.__updateIfNeed();
      });
    }
    __render() {
...
class DynamicRenderComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      super(attrs);
      const __vm_e2cc19144ac8 = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      __vm_e2cc19144ac8._currentAttrs = null;
      const fn_3_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.render = attrs.render;
      };
      fn_3_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('render', fn_3_e2cc19144ac8);
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('*', prop => {
        __vm_e2cc19144ac8._currentAttrs[prop[0]] = __vm_e2cc19144ac8[_core_component__WEBPACK_IMPORTED_MODULE_1__["__"]].passedAttrs[prop[0]];
      });
    }
    get render() {
        return this._r;
...
class ForEachComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs, item, index, isLast) {
      ...
      if (Object(_vm_common__WEBPACK_IMPORTED_MODULE_0__["isViewModel"])(item)) {
        __vm_e2cc19144ac8.each = item;
      } else {
        __vm_e2cc19144ac8._e = item;
      }
      __vm_e2cc19144ac8.index = index;
      __vm_e2cc19144ac8.isFirst = index === 0;
      __vm_e2cc19144ac8.isLast = isLast;
    }
    get each() {
        return this._e;
    }
...
class ForComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      if (Object(_vm_common__WEBPACK_IMPORTED_MODULE_0__["isViewModel"])(attrs.loop)) {
        __vm_e2cc19144ac8.loop = attrs.loop;
      } else {
        __vm_e2cc19144ac8._l = attrs.loop;
      }
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop', () => {
        __vm_e2cc19144ac8.loop = attrs.loop;
      });
      const kn = attrs.key || 'index';
      __vm_e2cc19144ac8._keyName = kn;
      __vm_e2cc19144ac8._length = 0;
      __vm_e2cc19144ac8._keys = null;
      __vm_e2cc19144ac8._waitingUpdate = false;
      if (kn !== 'index' && kn !== 'each') {
        __vm_e2cc19144ac8._keyName = new Function('each', `return ${ kn }`);
        const propCount = kn.split('.').length + 1;
        __vm_e2cc19144ac8[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop.*.' + kn.slice(5), propPath => {
          if (propPath.length !== propCount || __vm_e2cc19144ac8._waitingUpdate) {
            return;
          }
          const items = __vm_e2cc19144ac8.loop;
          ...
          __vm_e2cc19144ac8._keys[p] = __vm_e2cc19144ac8._keyName(items[p]);
        });
      }
      __vm_e2cc19144ac8[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('loop.*', propPath => {
        if (__vm_e2cc19144ac8[_core_component__WEBPACK_IMPORTED_MODULE_1__["__"]].state !== _core_component__WEBPACK_IMPORTED_MODULE_1__["ComponentStates"].RENDERED || propPath.length !== 2 || __vm_e2cc19144ac8._waitingUpdate) {
          return;
        }
        const p = _parseIndexPath(propPath[1]);
        if (p === 'length') {
          __vm_e2cc19144ac8._waitingUpdate = true;
          __vm_e2cc19144ac8.__updateIfNeed();
        } else if (Object(_util__WEBPACK_IMPORTED_MODULE_3__["isNumber"])(p)) {
          __vm_e2cc19144ac8._updateItem(p);
        }
      });
    }
    get loop() {
...
class BindHtmlComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      ...
      const __vm_e2cc19144ac8 = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      const fn_2_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.content = attrs.content;
      };
      fn_2_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('content', fn_2_e2cc19144ac8);
    }
    get content() {
        return this._c;
    }
...
class I18nComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs, renderKey, renderVms) {
      super(attrs);
      const __vm_e2cc19144ac8 = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      __vm_e2cc19144ac8._key = renderKey;
      __vm_e2cc19144ac8._vms = renderVms;
      __vm_e2cc19144ac8.__i18nWatch(__vm_e2cc19144ac8._onchange);
    }
    __render() {
...
class IfComponent extends _core_component__WEBPACK_IMPORTED_MODULE_2__["Component"] {
    constructor(attrs) {
      super(attrs);
      const __vm_e2cc19144ac8 = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      __vm_e2cc19144ac8._currentValue = 'default';
      __vm_e2cc19144ac8._onEndHandler = null;
      __vm_e2cc19144ac8._transitionMap = null;
      __vm_e2cc19144ac8._previousValue = null;
      const fn_5_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.expect = attrs.expect;
      };
      fn_5_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('expect', fn_5_e2cc19144ac8);
      const fn_6_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.transition = attrs.transition;
      };
      fn_6_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('transition', fn_6_e2cc19144ac8);
    }
    get expect() {
...
class SwitchComponent extends _core_component__WEBPACK_IMPORTED_MODULE_2__["Component"] {
    constructor(attrs) {
      ...
      __vm_e2cc19144ac8._transitionMap = null;
      __vm_e2cc19144ac8._previousValue = null;
      __vm_e2cc19144ac8._currentValue = null;
      const fn_5_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.test = attrs.test;
      };
      fn_5_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('test', fn_5_e2cc19144ac8);
      const fn_6_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.transition = attrs.transition;
      };
      fn_6_e2cc19144ac8();
...
class LogComponent extends _core_component__WEBPACK_IMPORTED_MODULE_1__["Component"] {
    constructor(attrs) {
      super(attrs);
      const __vm_e2cc19144ac8 = this[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
      const fn_1_e2cc19144ac8 = () => {
        __vm_e2cc19144ac8.msg = attrs.msg;
      };
      fn_1_e2cc19144ac8();
      attrs[_vm_common__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('msg', fn_1_e2cc19144ac8);
    }
    set msg(v) {
        // eslint-disable-next-line no-console
        console.log(v);
        ...
        ...(() => {
          const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
            [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
              ...
              listeners: {
                transition: { fn: function(...args) { vm_0.handleTransition(...args) }, opts: null }
            },
              slots: {
          ...
          const fn_0 = () => {
            attrs.class = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
              fade: vm_0.fade,
              slide: vm_0.slide
          });
          };
      ...
      ...(() => {
        const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
          [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
            ...
            context: component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].context,
            listeners: {
              transition: { fn: function(...args) { vm_0.log(...args) }, opts: null }
          },
            slots: {
              'default': function(component) {
            return [
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    super(args);
    const __vm_e2cc19144ac8 = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    __vm_e2cc19144ac8.fade = false;
    __vm_e2cc19144ac8.slide = true;
    __vm_e2cc19144ac8.show = true;
    __vm_e2cc19144ac8.si = 0;
  }
