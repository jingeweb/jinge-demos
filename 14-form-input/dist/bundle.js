...
/* harmony import */ var ___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! .. */ "../../jinge-framework/index.js");
...
class ToggleClassComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs) {
    ...
    const vm_c4ffe1d792 = super(attrs);
    const fn_c4ffe1d792_2 = () => {
      vm_c4ffe1d792.class = attrs.class;
    };
    fn_c4ffe1d792_2();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('class', fn_c4ffe1d792_2);
    const fn_c4ffe1d792_3 = () => {
      vm_c4ffe1d792.trans = !!attrs.transition;
    };
    fn_c4ffe1d792_3();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('transition', fn_c4ffe1d792_3);
    vm_c4ffe1d792._t = null;
    vm_c4ffe1d792._i = null;
    Object(_vm__WEBPACK_IMPORTED_MODULE_3__["vmWatch"])(this, 'class.**', () => {
      vm_c4ffe1d792[_core__WEBPACK_IMPORTED_MODULE_1__["UPDATE_IF_NEED"]]();
    });
    return vm_c4ffe1d792;
  }
...
class ForEachComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs, item, index, isLast) {
    const vm_c4ffe1d792 = super(attrs);
    vm_c4ffe1d792.each = item;
    vm_c4ffe1d792.index = index;
    vm_c4ffe1d792.isFirst = index === 0;
    vm_c4ffe1d792.isLast = isLast;
    return vm_c4ffe1d792;
  }
...
function createEl(item, i, isLast, itemRenderFn, context, cstyPid) {
  const el = new ForEachComponent(Object(_vm__WEBPACK_IMPORTED_MODULE_3__["wrapAttrs"])({
    [_vm__WEBPACK_IMPORTED_MODULE_3__["VM_DEBUG_NAME"]]: 'attrs_of_<for-each>',
    [_vm__WEBPACK_IMPORTED_MODULE_3__["VM_ATTRS"]]: null,
...
function _assertVm(item, i) {
  if (Object(_util__WEBPACK_IMPORTED_MODULE_2__["isObject"])(item) && !Object(_vm__WEBPACK_IMPORTED_MODULE_3__["isInnerObj"])(item) && !(_vm__WEBPACK_IMPORTED_MODULE_3__["VM_ATTRS"] in item)) {
...
class ForComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs) {
    ...
    const vm_c4ffe1d792 = super(attrs);
    const fn_c4ffe1d792_2 = () => {
      vm_c4ffe1d792.loop = attrs.loop;
    };
    fn_c4ffe1d792_2();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('loop', fn_c4ffe1d792_2);
    vm_c4ffe1d792[ID] = INC++;
    const kn = attrs.key || KEY_INDEX;
    vm_c4ffe1d792[FOR_KEY_NAME] = kn;
    vm_c4ffe1d792[FOR_LENGTH] = 0;
    vm_c4ffe1d792[FOR_KEYS] = null;
    vm_c4ffe1d792[FOR_WAIT_UPDATE] = false;
    if (kn !== KEY_INDEX && kn !== KEY_EACH) {
      vm_c4ffe1d792[FOR_KEY_NAME] = new Function(KEY_EACH, `return ${ kn }`);
      const propCount = kn.split('.').length + 1;
      Object(_vm__WEBPACK_IMPORTED_MODULE_3__["vmWatch"])(this, 'loop.*.' + kn.slice(5), propPath => {
        if (propPath.length !== propCount || vm_c4ffe1d792[FOR_WAIT_UPDATE]) {
          return;
        }
        const items = vm_c4ffe1d792.loop;
        ...
        vm_c4ffe1d792[FOR_KEYS][p] = vm_c4ffe1d792[FOR_KEY_NAME](items[p]);
      });
    }
    Object(_vm__WEBPACK_IMPORTED_MODULE_3__["vmWatch"])(this, 'loop.*', propPath => {
      if (vm_c4ffe1d792[_core__WEBPACK_IMPORTED_MODULE_1__["STATE"]] !== _core__WEBPACK_IMPORTED_MODULE_1__["STATE_RENDERED"] || propPath.length !== 2 || vm_c4ffe1d792[FOR_WAIT_UPDATE]) {
        return;
      }
      const p = _parseIndexPath(propPath[1]);
      if (p === _util__WEBPACK_IMPORTED_MODULE_2__["STR_LENGTH"]) {
        vm_c4ffe1d792[FOR_WAIT_UPDATE] = true;
        vm_c4ffe1d792[_core__WEBPACK_IMPORTED_MODULE_1__["UPDATE_IF_NEED"]]();
      } else if (Object(_util__WEBPACK_IMPORTED_MODULE_2__["isNumber"])(p)) {
        vm_c4ffe1d792[FOR_UPDATE_ITEM](p);
      }
    });
    return vm_c4ffe1d792;
  }
...
class BindHtmlComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs) {
    ...
    const vm_c4ffe1d792 = super(attrs);
    const fn_c4ffe1d792_3 = () => {
      vm_c4ffe1d792.c = attrs.content;
    };
    fn_c4ffe1d792_3();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('content', fn_c4ffe1d792_3);
    return vm_c4ffe1d792;
  }
...
class I18nComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs, renderKey, renderVms) {
    const vm_c4ffe1d792 = super(attrs);
    vm_c4ffe1d792[RENDER_KEY] = renderKey;
    vm_c4ffe1d792[RENDER_VMS] = renderVms;
    vm_c4ffe1d792[_core__WEBPACK_IMPORTED_MODULE_1__["I18N_WATCH"]](vm_c4ffe1d792[ON_LOCALE_CHANGE]);
    return vm_c4ffe1d792;
  }
  ...
  [_core__WEBPACK_IMPORTED_MODULE_1__["UPDATE"]]() {
    Object(_vm__WEBPACK_IMPORTED_MODULE_3__["vmRelatedClear"])(this[_vm__WEBPACK_IMPORTED_MODULE_3__["VM_RELATED_LISTENERS"]]);
...
function createEl(renderFn, context, parentStyleIds) {
  const el = new _core__WEBPACK_IMPORTED_MODULE_1__["Component"](Object(_vm__WEBPACK_IMPORTED_MODULE_3__["wrapAttrs"])({
    [_vm__WEBPACK_IMPORTED_MODULE_3__["VM_DEBUG_NAME"]]: 'attrs_of_<if>',
    [_vm__WEBPACK_IMPORTED_MODULE_3__["VM_ATTRS"]]: null,
    [_core__WEBPACK_IMPORTED_MODULE_1__["CONTEXT"]]: context,
    [_core__WEBPACK_IMPORTED_MODULE_1__["ARG_COMPONENTS"]]: {
...
class IfComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs) {
    const vm_c4ffe1d792 = super(attrs);
    vm_c4ffe1d792[C_VAL] = _util__WEBPACK_IMPORTED_MODULE_2__["STR_DEFAULT"];
    vm_c4ffe1d792[OE_H] = null;
    vm_c4ffe1d792[T_MAP] = null;
    vm_c4ffe1d792[P_VAL] = null;
    const fn_c4ffe1d792_5 = () => {
      vm_c4ffe1d792.expect = attrs.expect;
    };
    fn_c4ffe1d792_5();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('expect', fn_c4ffe1d792_5);
    const fn_c4ffe1d792_6 = () => {
      vm_c4ffe1d792.ts = attrs.transition;
    };
    fn_c4ffe1d792_6();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('transition', fn_c4ffe1d792_6);
    return vm_c4ffe1d792;
  }
...
class SwitchComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs) {
    ...
    vm_c4ffe1d792[T_MAP] = null;
    vm_c4ffe1d792[P_VAL] = null;
    const fn_c4ffe1d792_4 = () => {
      vm_c4ffe1d792.test = attrs.test;
    };
    fn_c4ffe1d792_4();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('test', fn_c4ffe1d792_4);
    const fn_c4ffe1d792_5 = () => {
      vm_c4ffe1d792.ts = attrs.transition;
    };
    fn_c4ffe1d792_5();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('transition', fn_c4ffe1d792_5);
    return vm_c4ffe1d792;
  }
...
class LogComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs) {
    const vm_c4ffe1d792 = super(attrs);
    const fn_c4ffe1d792_1 = () => {
      vm_c4ffe1d792.msg = attrs.msg;
    };
    fn_c4ffe1d792_1();
    attrs[___WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][___WEBPACK_IMPORTED_MODULE_0__["VM_ON"]]('msg', fn_c4ffe1d792_1);
    return vm_c4ffe1d792;
  }
...
class ParameterComponent extends _core__WEBPACK_IMPORTED_MODULE_1__["Component"] {
  constructor(attrs, params) {
    const vm_c4ffe1d792 = super(attrs);
    params.forEach(p => {
      vm_c4ffe1d792[p] = attrs[p];
      attrs[_vm__WEBPACK_IMPORTED_MODULE_2__["VM_ATTRS"]][_vm__WEBPACK_IMPORTED_MODULE_2__["VM_ON"]](p, () => {
        vm_c4ffe1d792[p] = attrs[p];
      });
    });
    return vm_c4ffe1d792;
      ...
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          (() => {
            ...
            const fn_0 = () => {
              el[jinge__WEBPACK_IMPORTED_MODULE_0__["HTML_ATTR_value"]] = function () {
                let _0;
                return (_0 = vm_0.data) === null || _0 === void 0 ? void 0 : _0.t;
            }();
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["data","t"], fn_0, component);
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'input', function(...args) {vm_0.data.t = args[0].target.value})
            return el;
          })()
        ),
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          (() => {
            const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
              ...
              (() => {
                ...
                fn_0();
                vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["data","t2"], fn_0, component);
                return el;
              })()
            );
            const fn_0 = () => {
              Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setAttribute"])(el, "placeholder", 'input ' + function () {
                let _0;
                return (_0 = vm_0.data) === null || _0 === void 0 ? void 0 : _0.t;
            }());
            };
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["data","t"], fn_0, component);
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'input', function(...args) {vm_0.data.t2 = args[0].target.value})
            return el;
          })()
        ),
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          (() => {
            ...
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["data","t3"], fn_0, component);
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'change', function(...args) {vm_0.data.t3 = args[0].target.checked})
            return el;
          })(),
          Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
            "label",
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          ...(() => {
                  ...
                  (() => {
                    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                      ...
                      (() => {
                        ...
                        fn_0();
                        vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["each","selected"], fn_0, component);
                        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'change', function(...args) {(vm_1.each.selected = args[0].target.checked) ? vm_0.add(vm_1.each.name) : vm_0.del(vm_1.each.name)})
                        return el;
                      })(),
                      (() => {
                        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createTextNode"])();
                        ...
                        fn_0();
                        vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["each","name"], fn_0, component);
                        return el;
                      })()
                    );
                    component[jinge__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]].push(el);
            ...
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["fruits4"], fn_0, component);
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          ...(() => {
                  ...
                  (() => {
                    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
                      ...
                      (() => {
                        ...
                        const fn_0 = () => {
                          el[jinge__WEBPACK_IMPORTED_MODULE_0__["HTML_ATTR_checked"]] = !!(vm_1.each === function () {
                            let _0;
                        ...
                        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["data","t5"], fn_0, component);
                        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'click', function(...args) {vm_0.data.t5 = vm_1.each})
                        return el;
                      })(),
                      (() => {
                        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createTextNode"])();
                        const fn_0 = () => {
                          Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, vm_1.each);
                        };
                        fn_0();
                        vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["each"], fn_0, component);
                        return el;
            ...
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["fruits5"], fn_0, component);
            const el = new jinge__WEBPACK_IMPORTED_MODULE_0__["ForComponent"](attrs);
            component[jinge__WEBPACK_IMPORTED_MODULE_0__["NON_ROOT_COMPONENT_NODES"]].push(el);
            return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el[jinge__WEBPACK_IMPORTED_MODULE_0__["RENDER"]](component));
          })()
        ...
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          (() => {
                  ...
                  [jinge__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
                    [jinge__WEBPACK_IMPORTED_MODULE_0__["STR_DEFAULT"]]: function(component) {
                      ...
                      (() => {
                        ...
                        const fn_0 = () => {
                          el[jinge__WEBPACK_IMPORTED_MODULE_0__["HTML_ATTR_value"]] = vm_1.each;
                        };
                        fn_0();
                        vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["each"], fn_0, component);
                        component[jinge__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]].push(el);
            ...
            fn_0();
            vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["data","t6"], fn_0, component);
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'change', function(...args) {vm_0.data.t6 = args[0].target.value})
            return el;
          })()
        ),
        Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElementWithoutAttrs"])(
          ...
          (() => {
                  ...
                  [jinge__WEBPACK_IMPORTED_MODULE_0__["ARG_COMPONENTS"]]: {
                    [jinge__WEBPACK_IMPORTED_MODULE_0__["STR_DEFAULT"]]: function(component) {
                      ...
                      (() => {
                        ...
                        vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["each","name"], fn_0, component);
                        const fn_1 = () => {
                          el[jinge__WEBPACK_IMPORTED_MODULE_0__["HTML_ATTR_selected"]] = !!(function () {
                            let _0;
                            return (_0 = vm_1.each) === null || _0 === void 0 ? void 0 : _0.selected;
                        }());
                        };
                        fn_1();
                        vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["each","selected"], fn_1, component);
                        component[jinge__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]].push(el);
                        return el;
                      })()
                      ];
            ...
            Object(jinge__WEBPACK_IMPORTED_MODULE_0__["addEvent"])(el, 'change', function(...args) {vm_0.onMultiSelectChange(args[0].target)})
            return el;
          })()
        )
      )
  ...
  (() => {
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      (() => {
        const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createTextNode"])();
        const fn_0 = () => {
          Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, vm_0.output);
        };
        fn_0();
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ATTRS"]][jinge__WEBPACK_IMPORTED_MODULE_0__["VM_ON"]](["output"], fn_0, component);
        return el;
      })()
    );
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["ROOT_NODES"]].push(el);
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    const vm_c4ffe1d792 = super(args);
    vm_c4ffe1d792.data = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["VM"])({
      t: 'hello',
      t2: 'hello\njinge',
      t3: true,
      t4: [],
    ...
    vm_c4ffe1d792.fruits5 = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["VM"])([
      'Apple',
      'Orange',
      'Banana'
    ]);
    vm_c4ffe1d792.fruits4 = vm_c4ffe1d792.fruits5.map(f => ({
      name: f,
      selected: false
    }));
    vm_c4ffe1d792.output = vm_c4ffe1d792.genOutput();
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vmWatch"])(this, 'data.**', () => {
      vm_c4ffe1d792.output = vm_c4ffe1d792.genOutput();
    });
    return vm_c4ffe1d792;
  }
