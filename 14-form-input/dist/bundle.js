...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    ...
    __vm_a7743eb1190c.fruits5 = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([
      'Apple',
      'Orange',
      'Banana'
    ]);
    __vm_a7743eb1190c.fruits4 = __vm_a7743eb1190c.fruits5.map(f => ({
      name: f,
      selected: false
    }));
    __vm_a7743eb1190c.output = JSON.stringify(__vm_a7743eb1190c.data, null, 2);
    Object(jinge__WEBPACK_IMPORTED_MODULE_0__["watch"])(__vm_a7743eb1190c, 'data.**', p => {
      __vm_a7743eb1190c.__updateIfNeed();
    });
  }
  log(...args) {
