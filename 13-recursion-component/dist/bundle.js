...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  ...
  constructor(args) {
    ...
    _jg0.treeData = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)({
      name: 'root',
      children: [{
        name: 'c-1',
        children: [{
...
/* harmony export */ });
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge/lib/index.js");
/* harmony import */ var _tree_node_c_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tree-node.c.html */ "./components/tree-node.c.html");
...
class TreeNode extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  static get template() {
    return _tree_node_c_html__WEBPACK_IMPORTED_MODULE_1__["default"];
  }
  constructor(attrs) {
    super(attrs);const _jg0 = this[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;const f1_jg0402 = () => {
    _jg0.nodeLevel = attrs.nodeLevel || 0; }; f1_jg0402(); attrs[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch("nodeLevel", f1_jg0402);const f2_jg0402 = () => {
    _jg0.nodeData = attrs.nodeData; }; f2_jg0402(); attrs[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch("nodeData", f2_jg0402);
  }
}

/***/ }),

/***/ "./components/tree.c.js":
/*!******************************!*\
  !*** ./components/tree.c.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge/lib/index.js");
/* harmony import */ var _tree_c_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tree.c.html */ "./components/tree.c.html");


class Tree extends jinge__WEBPACK_IMPORTED_MODULE_0__.Component {
  static get template() {
    return _tree_c_html__WEBPACK_IMPORTED_MODULE_1__["default"];
  }
  constructor(attrs) {
    super(attrs);const _jg0 = this[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].proxy;const f1_jg0402 = () => {
    _jg0.data = attrs.data; }; f1_jg0402(); attrs[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch("data", f1_jg0402);
  }
  get data() {
    return this._data;
  }
  set data(v) {
    this._data = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.isArray)(v) ? v : (0,jinge__WEBPACK_IMPORTED_MODULE_0__.vm)([v]);
  }
}
...
/* harmony export */ });
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge/lib/index.js");
/* harmony import */ var _components_tree_c_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/tree.c.js */ "./components/tree.c.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(component) {
  ...
  ...(() => {
    ...
    const el = _components_tree_c_js__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
    component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
...
/* harmony export */ });
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge/lib/index.js");
/* harmony import */ var _tree_node_c__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tree-node.c */ "./components/tree-node.c.js");
...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(component) {
  ...
  (() => {
    const el = (0,jinge__WEBPACK_IMPORTED_MODULE_0__.createElementWithoutAttrs)(
      ...
      (() => {
        ...
        const fn_0 = () => {
          (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setText)(el, `${vm_0.nodeData?.name}`);
        };
        fn_0();
    ...
    const fn_0 = () => {
      (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setAttribute)(el, "style", `padding-left: ${vm_0.nodeLevel * 20}px;`);
    };
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["nodeLevel"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
    const fn_1 = () => {
      (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setAttribute)(el, "class", `tree-node ${vm_0.nodeData?.children && vm_0.nodeData?.children?.length > 0 ? 'parent' : 'leaf'}`);
    };
    fn_1();
  ...
  ...(() => {
        ...
        slots: {
          'default': function(component) {
            ...
            ...(() => {
                  ...
                  slots: {
                    'default': function(component) {
                      ...
                      ...(() => {
                        ...
                        const el = _tree_node_c__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
                        component[jinge__WEBPACK_IMPORTED_MODULE_0__.__].rootNodes.push(el);
                        return (0,jinge__WEBPACK_IMPORTED_MODULE_0__.assertRenderResults)(el.__render());
                      })()
                      ];
              ...
              const fn_0 = () => {
                attrs.loop = vm_0.nodeData?.children;
              };
              fn_0();
    ...
    const fn_0 = () => {
      attrs.expect = vm_0.nodeData?.children && vm_0.nodeData?.children?.length > 0;
    };
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["nodeData","children"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
