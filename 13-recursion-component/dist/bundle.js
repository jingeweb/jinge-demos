...
/* harmony default export */ function __WEBPACK_DEFAULT_EXPORT__(component) {  
  ...
  (() => {
    ...
    const fn_0 = () => {
      (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setStyleAttribute)(el, `padding-left: ${vm_0.nodeLevel * 20}px;`);
    };
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__.$$].__watch(["nodeLevel"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__.$$]);
    const fn_1 = () => {
      (0,jinge__WEBPACK_IMPORTED_MODULE_0__.setClassAttribute)(el, `tree-node ${vm_0.nodeData?.children && vm_0.nodeData?.children?.length > 0 ? 'parent' : 'leaf'}`);
    };
    fn_1();
