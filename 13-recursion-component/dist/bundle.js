...
/* harmony import */ var _components_tree_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/tree.js */ "./components/tree.js");
...
/* harmony default export */ __webpack_exports__["default"] = (function(component) {
  ...
  (() => {
    const el = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["createElement"])(
      ...
      "Recursion Component - Simple Tree"
    );
  ...
  ...(() => {
    const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
      [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
        debugName: "attrs_of_<Tree>",
        context: component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].context,
      },
      data: null
    });
    const fn_0 = () => {
      attrs.data = vm_0.treeData;
    };
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["treeData"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    const el = _components_tree_js__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge-framework/lib/index.js");
/* harmony import */ var _tree_node_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tree-node.js */ "./components/tree-node.js");
      ...
      (() => {
        ...
        const fn_0 = () => {
          Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setText"])(el, function () {
            let _0;
            return (_0 = vm_0.nodeData) === null || _0 === void 0 ? void 0 : _0.name;
        }());
        };
        fn_0();
        vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeData","name"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
        return el;
      })()
    );
    const fn_0 = () => {
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setAttribute"])(el, "style", 'padding-left: ' + vm_0.nodeLevel * 20 + 'px;');
    };
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeLevel"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    const fn_1 = () => {
      Object(jinge__WEBPACK_IMPORTED_MODULE_0__["setAttribute"])(el, "class", 'tree-node ' + (function () {
        let _0;
        return (_0 = vm_0.nodeData) === null || _0 === void 0 ? void 0 : _0.children;
    }() && function () {
        let _0, _1;
        return (_1 = (_0 = vm_0.nodeData) === null || _0 === void 0 ? void 0 : _0.children) === null || _1 === void 0 ? void 0 : _1.length;
    }() > 0 ? 'parent' : 'leaf'));
    };
    fn_1();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeData","children"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeData","children","length"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
    return el;
  })(),
  ...(() => {
    const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
      [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
        ...
        ...(() => {
          const attrs = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["attrs"])({
            [jinge__WEBPACK_IMPORTED_MODULE_0__["__"]]: {
              ...
              ...(() => {
                ...
                const fn_0 = () => {
                  attrs.nodeLevel = vm_0.nodeLevel + 1;
                };
                fn_0();
                vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeLevel"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                const fn_1 = () => {
                  attrs.nodeData = vm_1.each;
                };
                fn_1();
                vm_1[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["each"], fn_1, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
                const el = _tree_node_js__WEBPACK_IMPORTED_MODULE_1__["default"].create(attrs);
                el.__addStylePid(component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].compStylePid);
                component[jinge__WEBPACK_IMPORTED_MODULE_0__["__"]].rootNodes.push(el);
                return Object(jinge__WEBPACK_IMPORTED_MODULE_0__["assertRenderResults"])(el.__render());
              })()
          ...
          fn_0();
          vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeData","children"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    ...
    fn_0();
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeData","children"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
    vm_0[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch(["nodeData","children","length"], fn_0, component[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]]);
...
/* harmony import */ var jinge__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! jinge */ "../../jinge-framework/lib/index.js");
/* harmony import */ var _tree_node_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./tree-node.html */ "./components/tree-node.html");




class TreeNode extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static get template() {
    return _tree_node_html__WEBPACK_IMPORTED_MODULE_1__["default"];
  }
  constructor(attrs) {
    super(attrs);
    const __vm_a7743eb1190c = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    const fn_1_a7743eb1190c = () => {
      __vm_a7743eb1190c.nodeLevel = attrs.nodeLevel || 0;
    };
    fn_1_a7743eb1190c();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('nodeLevel', fn_1_a7743eb1190c);
    const fn_2_a7743eb1190c = () => {
      __vm_a7743eb1190c.nodeData = attrs.nodeData;
    };
    fn_2_a7743eb1190c();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('nodeData', fn_2_a7743eb1190c);
  }
}
...
class Tree extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  static get template() {
  ...
  constructor(attrs) {
    ...
    fn_1_a7743eb1190c();
    attrs[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].__watch('data', fn_1_a7743eb1190c);
  }
  get data() {
    return this._data;
  }
  set data(v) {
    this._data = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["isArray"])(v) ? v : Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])([v]);
  }
}
...
class App extends jinge__WEBPACK_IMPORTED_MODULE_0__["Component"] {
  ...
  constructor(args) {
    super(args);
    const __vm_a7743eb1190c = this[jinge__WEBPACK_IMPORTED_MODULE_0__["$$"]].proxy;
    __vm_a7743eb1190c.treeData = Object(jinge__WEBPACK_IMPORTED_MODULE_0__["vm"])({
      name: 'root',
      children: [
        {
          name: 'c-1',
